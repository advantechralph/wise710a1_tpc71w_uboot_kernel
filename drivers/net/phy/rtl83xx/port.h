 ...
 */
extern rtk_api_ret_t rtk_port_phyAutoNegoAbility_set(struct phy_device *phydev, rtk_port_t port, rtk_port_phy_ability_t *pAbility);
 ...
 */
extern rtk_api_ret_t rtk_port_phyAutoNegoAbility_get(struct phy_device *phydev, rtk_port_t port, rtk_port_phy_ability_t *pAbility);
 ...
 *      be set as following 100F > 100H > 10F > 10H priority sequence.
 */
extern rtk_api_ret_t rtk_port_phyForceModeAbility_set(struct phy_device *phydev, rtk_port_t port, rtk_port_phy_ability_t *pAbility);
 ...
 *      Get the capablity of specified PHY.
 */
extern rtk_api_ret_t rtk_port_phyForceModeAbility_get(struct phy_device *phydev, rtk_port_t port, rtk_port_phy_ability_t *pAbility);
 ...
 */
extern rtk_api_ret_t rtk_port_phyStatus_get(struct phy_device *phydev, rtk_port_t port, rtk_port_linkStatus_t *pLinkStatus, rtk_port_speed_t *pSpeed, rtk_port_duplex_t *pDuplex);
 ...
 */
extern rtk_api_ret_t rtk_port_macForceLink_set(struct phy_device *phydev, rtk_port_t port, rtk_port_mac_ability_t *pPortability);
 ...
 */
extern rtk_api_ret_t rtk_port_macForceLink_get(struct phy_device *phydev, rtk_port_t port, rtk_port_mac_ability_t *pPortability);
 ...
 *      - MODE_EXT_100FX,
 */
extern rtk_api_ret_t rtk_port_macForceLinkExt_set(struct phy_device *phydev, rtk_port_t port, rtk_mode_ext_t mode, rtk_port_mac_ability_t *pPortability);
 ...
 */
extern rtk_api_ret_t rtk_port_macForceLinkExt_get(struct phy_device *phydev, rtk_port_t port, rtk_mode_ext_t *pMode, rtk_port_mac_ability_t *pPortability);
 ...
 */
extern rtk_api_ret_t rtk_port_macStatus_get(struct phy_device *phydev, rtk_port_t port, rtk_port_mac_ability_t *pPortstatus);
 ...
 */
extern rtk_api_ret_t rtk_port_macLocalLoopbackEnable_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t enable);
 ...
 *      None.
 */
extern rtk_api_ret_t rtk_port_macLocalLoopbackEnable_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pEnable);
 ...
 */
extern rtk_api_ret_t rtk_port_phyReg_set(struct phy_device *phydev, rtk_port_t port, rtk_port_phy_reg_t reg, rtk_port_phy_data_t value);
 ...
 */
extern rtk_api_ret_t rtk_port_phyReg_get(struct phy_device *phydev, rtk_port_t port, rtk_port_phy_reg_t reg, rtk_port_phy_data_t *pData);
 ...
 *      - ENABLE
 */
extern rtk_api_ret_t rtk_port_backpressureEnable_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t enable);
 ...
 *      - ENABLE
 */
extern rtk_api_ret_t rtk_port_backpressureEnable_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pEnable);
 ...
 *      - ENABLE
 */
extern rtk_api_ret_t rtk_port_adminEnable_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t enable);
 ...
 *      - ENABLE
 */
extern rtk_api_ret_t rtk_port_adminEnable_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pEnable);
 ...
 */
extern rtk_api_ret_t rtk_port_isolation_set(struct phy_device *phydev, rtk_port_t port, rtk_portmask_t *pPortmask);
 ...
 *      A port can only transmit packet to ports included in permitted portmask
 */
extern rtk_api_ret_t rtk_port_isolation_get(struct phy_device *phydev, rtk_port_t port, rtk_portmask_t *pPortmask);
 ...
 */
extern rtk_api_ret_t rtk_port_rgmiiDelayExt_set(struct phy_device *phydev, rtk_port_t port, rtk_data_t txDelay, rtk_data_t rxDelay);
 ...
 */
extern rtk_api_ret_t rtk_port_rgmiiDelayExt_get(struct phy_device *phydev, rtk_port_t port, rtk_data_t *pTxDelay, rtk_data_t *pRxDelay);
 ...
 *      - ENABLE
 */
extern rtk_api_ret_t rtk_port_phyEnableAll_set(struct phy_device *phydev, rtk_enable_t enable);
 ...
 *      - ENABLE
 */
extern rtk_api_ret_t rtk_port_phyEnableAll_get(struct phy_device *phydev, rtk_enable_t *pEnable);
 ...
 */
extern rtk_api_ret_t rtk_port_efid_set(struct phy_device *phydev, rtk_port_t port, rtk_data_t efid);
 ...
 */
extern rtk_api_ret_t rtk_port_efid_get(struct phy_device *phydev, rtk_port_t port, rtk_data_t *pEfid);
 ...
 */
extern rtk_api_ret_t rtk_port_phyComboPortMedia_set(struct phy_device *phydev, rtk_port_t port, rtk_port_media_t media);
 ...
 *      The API can Set Combo port media type.
 */
extern rtk_api_ret_t rtk_port_phyComboPortMedia_get(struct phy_device *phydev, rtk_port_t port, rtk_port_media_t *pMedia);
 ...
 */
extern rtk_api_ret_t rtk_port_rtctEnable_set(struct phy_device *phydev, rtk_portmask_t *pPortmask);
 ...
 */
extern rtk_api_ret_t rtk_port_rtctResult_get(struct phy_device *phydev, rtk_port_t port, rtk_rtctResult_t *pRtctResult);
 ...
 */
extern rtk_api_ret_t rtk_port_sds_reset(struct phy_device *phydev, rtk_port_t port);
 ...
 *      The API can reset Serdes
 */
extern rtk_api_ret_t rtk_port_sgmiiLinkStatus_get(struct phy_device *phydev, rtk_port_t port, rtk_data_t *pSignalDetect, rtk_data_t *pSync, rtk_port_linkStatus_t *pLink);
 ...
 */
extern rtk_api_ret_t rtk_port_sgmiiNway_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t state);
 ...
 */
extern rtk_api_ret_t rtk_port_sgmiiNway_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pState);
