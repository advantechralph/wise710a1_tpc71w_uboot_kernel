 ...
 *
 */
extern rtk_api_ret_t rtk_rate_stormControlMeterIdx_set(struct phy_device *phydev, rtk_port_t port, rtk_rate_storm_group_t stormType, rtk_uint32 index);
 ...
 *
 */
extern rtk_api_ret_t rtk_rate_stormControlMeterIdx_get(struct phy_device *phydev, rtk_port_t port, rtk_rate_storm_group_t stormType, rtk_uint32 *pIndex);
 ...
 *
 */
extern rtk_api_ret_t rtk_rate_stormControlPortEnable_set(struct phy_device *phydev, rtk_port_t port, rtk_rate_storm_group_t stormType, rtk_enable_t enable);
 ...
 *
 */
extern rtk_api_ret_t rtk_rate_stormControlPortEnable_get(struct phy_device *phydev, rtk_port_t port, rtk_rate_storm_group_t stormType, rtk_enable_t *pEnable);
 ...
 *      - BYPASS_IGMP.
 */
extern rtk_api_ret_t rtk_storm_bypass_set(struct phy_device *phydev, rtk_storm_bypass_t type, rtk_enable_t enable);
 ...
 *      - BYPASS_IGMP.
 */
extern rtk_api_ret_t rtk_storm_bypass_get(struct phy_device *phydev, rtk_storm_bypass_t type, rtk_enable_t *pEnable);
 ...
 *
 */
extern rtk_api_ret_t rtk_rate_stormControlExtPortmask_set(struct phy_device *phydev, rtk_portmask_t *pPortmask);
 ...
 *
 */
extern rtk_api_ret_t rtk_rate_stormControlExtPortmask_get(struct phy_device *phydev, rtk_portmask_t *pPortmask);
 ...
 *
 */
extern rtk_api_ret_t rtk_rate_stormControlExtEnable_set(struct phy_device *phydev, rtk_rate_storm_group_t stormType, rtk_enable_t enable);
 ...
 *
 */
extern rtk_api_ret_t rtk_rate_stormControlExtEnable_get(struct phy_device *phydev, rtk_rate_storm_group_t stormType, rtk_enable_t *pEnable);
 ...
 *
 */
extern rtk_api_ret_t rtk_rate_stormControlExtMeterIdx_set(struct phy_device *phydev, rtk_rate_storm_group_t stormType, rtk_uint32 index);
 ...
 *
 */
extern rtk_api_ret_t rtk_rate_stormControlExtMeterIdx_get(struct phy_device *phydev, rtk_rate_storm_group_t stormType, rtk_uint32 *pIndex);
