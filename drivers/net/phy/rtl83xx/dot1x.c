 ...
 */
rtk_api_ret_t rtk_dot1x_unauthPacketOper_set(struct phy_device *phydev, rtk_port_t port, rtk_dot1x_unauth_action_t unauth_action)
{
    ...
    if ((retVal = rtl8367c_setAsic1xProcConfig(phydev, rtk_switch_port_L2P_get(phydev, port), unauth_action)) != RT_ERR_OK)
        return retVal;
 ...
 *      - DOT1X_ACTION_GUESTVLAN
 */
rtk_api_ret_t rtk_dot1x_unauthPacketOper_get(struct phy_device *phydev, rtk_port_t port, rtk_dot1x_unauth_action_t *pUnauth_action)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsic1xProcConfig(phydev, rtk_switch_port_L2P_get(phydev, port), pUnauth_action)) != RT_ERR_OK)
        return retVal;
 ...
 *      - ENABLED
 */
rtk_api_ret_t rtk_dot1x_eapolFrame2CpuEnable_set(struct phy_device *phydev, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicRma(phydev, 3, &rmacfg)) != RT_ERR_OK)
        return retVal;
    ...
    if ((retVal = rtl8367c_setAsicRma(phydev, 3, &rmacfg)) != RT_ERR_OK)
        return retVal;
 ...
 *      - ENABLED
 */
rtk_api_ret_t rtk_dot1x_eapolFrame2CpuEnable_get(struct phy_device *phydev, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
    rtl8367c_rma_t rmacfg;
 ...
 *      - ENABLED
 */
rtk_api_ret_t rtk_dot1x_portBasedEnable_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsic1xPBEnConfig(phydev, rtk_switch_port_L2P_get(phydev, port),enable)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_dot1x_portBasedEnable_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsic1xPBEnConfig(phydev, rtk_switch_port_L2P_get(phydev, port), pEnable)) != RT_ERR_OK)
        return retVal;
 ...
 *      - AUTH
 */
rtk_api_ret_t rtk_dot1x_portBasedAuthStatus_set(struct phy_device *phydev, rtk_port_t port, rtk_dot1x_auth_status_t port_auth)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsic1xPBAuthConfig(phydev, rtk_switch_port_L2P_get(phydev, port), port_auth)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_dot1x_portBasedAuthStatus_get(struct phy_device *phydev, rtk_port_t port, rtk_dot1x_auth_status_t *pPort_auth)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsic1xPBAuthConfig(phydev, rtk_switch_port_L2P_get(phydev, port), pPort_auth)) != RT_ERR_OK)
        return retVal;
    return RT_ERR_OK;
}
 ...
 *      - IN
 */
rtk_api_ret_t rtk_dot1x_portBasedDirection_set(struct phy_device *phydev, rtk_port_t port, rtk_dot1x_direction_t port_direction)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsic1xPBOpdirConfig(phydev, rtk_switch_port_L2P_get(phydev, port), port_direction)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_dot1x_portBasedDirection_get(struct phy_device *phydev, rtk_port_t port, rtk_dot1x_direction_t *pPort_direction)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsic1xPBOpdirConfig(phydev, rtk_switch_port_L2P_get(phydev, port), pPort_direction)) != RT_ERR_OK)
        return retVal;
 ...
 *      - ENABLED
 */
rtk_api_ret_t rtk_dot1x_macBasedEnable_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsic1xMBEnConfig(phydev, rtk_switch_port_L2P_get(phydev, port),enable)) != RT_ERR_OK)
        return retVal;
 ...
 *      - ENABLED
 */
rtk_api_ret_t rtk_dot1x_macBasedEnable_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsic1xMBEnConfig(phydev, rtk_switch_port_L2P_get(phydev, port), pEnable)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_dot1x_macBasedAuthMac_add(struct phy_device *phydev, rtk_port_t port, rtk_mac_t *pAuth_mac, rtk_fid_t fid)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    ...
    if ( RT_ERR_OK == retVal)
    {
        if (l2Table.spa != rtk_switch_port_L2P_get(phydev, port))
        ...
        l2Table.efid = 0;
        l2Table.auth = 1;
        retVal = rtl8367c_setAsicL2LookupTb(phydev, &l2Table);
        return retVal;
    }
    else
        return retVal;
 ...
 */
rtk_api_ret_t rtk_dot1x_macBasedAuthMac_del(struct phy_device *phydev, rtk_port_t port, rtk_mac_t *pAuth_mac, rtk_fid_t fid)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
 ...
 *      - IN
 */
rtk_api_ret_t rtk_dot1x_macBasedDirection_set(struct phy_device *phydev, rtk_dot1x_direction_t mac_direction)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsic1xMBOpdirConfig(phydev, mac_direction)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_dot1x_macBasedDirection_get(struct phy_device *phydev, rtk_dot1x_direction_t *pMac_direction)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsic1xMBOpdirConfig(phydev, pMac_direction)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_dot1x_guestVlan_set(struct phy_device *phydev, rtk_vlan_t vid)
{
    rtk_api_ret_t retVal;
    rtk_uint32 index;
    ...
    if((retVal = rtk_vlan_checkAndCreateMbr(phydev, vid, &index)) != RT_ERR_OK)
        return retVal;

    if ((retVal = rtl8367c_setAsic1xGuestVidx(phydev, index)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_dot1x_guestVlan_get(struct phy_device *phydev, rtk_vlan_t *pVid)
{
    rtk_api_ret_t retVal;
    rtk_uint32 gvidx;
    ...
    if ((retVal = rtl8367c_getAsic1xGuestVidx(phydev, &gvidx)) != RT_ERR_OK)
        return retVal;

    if ((retVal = rtl8367c_getAsicVlanMemberConfig(phydev, gvidx, &vlanMC)) != RT_ERR_OK)
        return retVal;
 ...
 *      - DISABLED
 */
rtk_api_ret_t rtk_dot1x_guestVlan2Auth_set(struct phy_device *phydev, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsic1xGVOpdir(phydev, enable)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_dot1x_guestVlan2Auth_get(struct phy_device *phydev, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsic1xGVOpdir(phydev, pEnable)) != RT_ERR_OK)
        return retVal;
