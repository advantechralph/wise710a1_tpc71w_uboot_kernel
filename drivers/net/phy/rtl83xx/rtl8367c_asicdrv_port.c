 ...
 *      None
 */
ret_t rtl8367c_setAsicPortUnknownDaBehavior(struct phy_device *phydev, rtk_uint32 port, rtk_uint32 behavior)
{
    ...
    if(port < 8)
        return rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_UNKNOWN_UNICAST_DA_PORT_BEHAVE, RTL8367C_Port0_ACTION_MASK << (port * 2), behavior);
    else
        return rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_UNKNOWN_UNICAST_DA_PORT_BEHAVE_EXT, RTL8367C_PORT8_ACTION_MASK << ((port-8) * 2), behavior);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortUnknownDaBehavior(struct phy_device *phydev, rtk_uint32 port, rtk_uint32 *pBehavior)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;

    if(port < 8)
        return rtl8367c_getAsicRegBits(phydev, RTL8367C_REG_UNKNOWN_UNICAST_DA_PORT_BEHAVE, RTL8367C_Port0_ACTION_MASK << (port * 2), pBehavior);
    else
        return rtl8367c_getAsicRegBits(phydev, RTL8367C_REG_UNKNOWN_UNICAST_DA_PORT_BEHAVE_EXT, RTL8367C_PORT8_ACTION_MASK << ((port-8) * 2), pBehavior);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortUnknownSaBehavior(struct phy_device *phydev, rtk_uint32 behavior)
{
    if(behavior >= L2_BEHAVE_SA_END)
        return RT_ERR_NOT_ALLOWED;

    return rtl8367c_setAsicRegBits(phydev, RTL8367C_PORT_SECURIT_CTRL_REG, RTL8367C_UNKNOWN_SA_BEHAVE_MASK, behavior);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortUnknownSaBehavior(struct phy_device *phydev, rtk_uint32 *pBehavior)
{
    return rtl8367c_getAsicRegBits(phydev, RTL8367C_PORT_SECURIT_CTRL_REG, RTL8367C_UNKNOWN_SA_BEHAVE_MASK, pBehavior);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortUnmatchedSaBehavior(struct phy_device *phydev, rtk_uint32 behavior)
{
    if(behavior >= L2_BEHAVE_SA_END)
        return RT_ERR_NOT_ALLOWED;

    return rtl8367c_setAsicRegBits(phydev, RTL8367C_PORT_SECURIT_CTRL_REG, RTL8367C_UNMATCHED_SA_BEHAVE_MASK, behavior);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortUnmatchedSaBehavior(struct phy_device *phydev, rtk_uint32 *pBehavior)
{
    return rtl8367c_getAsicRegBits(phydev, RTL8367C_PORT_SECURIT_CTRL_REG, RTL8367C_UNMATCHED_SA_BEHAVE_MASK, pBehavior);
}
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortUnmatchedSaMoving(struct phy_device *phydev, rtk_uint32 port, rtk_uint32 enabled)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;

    return rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_L2_SA_MOVING_FORBID, port, (enabled == 1) ? 0 : 1);
}
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortUnmatchedSaMoving(struct phy_device *phydev, rtk_uint32 port, rtk_uint32 *pEnabled)
{
    rtk_uint32 data;
    ret_t retVal;
    ...
    if((retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_L2_SA_MOVING_FORBID, port, &data)) != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortUnknownDaFloodingPortmask(struct phy_device *phydev, rtk_uint32 portmask)
{
    if(portmask > RTL8367C_PORTMASK)
        return RT_ERR_PORT_MASK;

    return rtl8367c_setAsicReg(phydev, RTL8367C_UNUCAST_FLOADING_PMSK_REG, portmask);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortUnknownDaFloodingPortmask(struct phy_device *phydev, rtk_uint32 *pPortmask)
{
    return rtl8367c_getAsicReg(phydev, RTL8367C_UNUCAST_FLOADING_PMSK_REG, pPortmask);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortUnknownMulticastFloodingPortmask(struct phy_device *phydev, rtk_uint32 portmask)
{
    if(portmask > RTL8367C_PORTMASK)
        return RT_ERR_PORT_MASK;

    return rtl8367c_setAsicReg(phydev, RTL8367C_UNMCAST_FLOADING_PMSK_REG, portmask);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortUnknownMulticastFloodingPortmask(struct phy_device *phydev, rtk_uint32 *pPortmask)
{
    return rtl8367c_getAsicReg(phydev, RTL8367C_UNMCAST_FLOADING_PMSK_REG, pPortmask);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortBcastFloodingPortmask(struct phy_device *phydev, rtk_uint32 portmask)
{
    if(portmask > RTL8367C_PORTMASK)
        return RT_ERR_PORT_MASK;

    return rtl8367c_setAsicReg(phydev, RTL8367C_BCAST_FLOADING_PMSK_REG, portmask);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortBcastFloodingPortmask(struct phy_device *phydev, rtk_uint32 *pPortmask)
{
    return rtl8367c_getAsicReg(phydev, RTL8367C_BCAST_FLOADING_PMSK_REG, pPortmask);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortBlockSpa(struct phy_device *phydev, rtk_uint32 port, rtk_uint32 permit)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;

    return rtl8367c_setAsicRegBit(phydev, RTL8367C_SOURCE_PORT_BLOCK_REG, port, permit);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortBlockSpa(struct phy_device *phydev, rtk_uint32 port, rtk_uint32* pPermit)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;

    return rtl8367c_getAsicRegBit(phydev, RTL8367C_SOURCE_PORT_BLOCK_REG, port, pPermit);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortDos(struct phy_device *phydev, rtk_uint32 type, rtk_uint32 drop)
{
    if(type >= DOS_END)
        return RT_ERR_OUT_OF_RANGE;

    return rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_DOS_CFG, RTL8367C_DROP_DAEQSA_OFFSET + type, drop);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortDos(struct phy_device *phydev, rtk_uint32 type, rtk_uint32* pDrop)
{
    if(type >= DOS_END)
        return RT_ERR_OUT_OF_RANGE;

    return rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_DOS_CFG, RTL8367C_DROP_DAEQSA_OFFSET + type,pDrop);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortForceLink(struct phy_device *phydev, rtk_uint32 port, rtl8367c_port_ability_t *pPortAbility)
{
    ...
    return rtl8367c_setAsicReg(phydev, RTL8367C_REG_MAC0_FORCE_SELECT+port, regData);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortForceLink(struct phy_device *phydev, rtk_uint32 port, rtl8367c_port_ability_t *pPortAbility)
{
    ret_t retVal;
    rtk_uint32 regData;
    ...
    retVal = rtl8367c_getAsicReg(phydev, RTL8367C_REG_MAC0_FORCE_SELECT + port, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortStatus(struct phy_device *phydev, rtk_uint32 port, rtl8367c_port_status_t *pPortStatus)
{
    ret_t retVal;
    rtk_uint32 regData;
    ...
    retVal = rtl8367c_getAsicReg(phydev, RTL8367C_REG_PORT0_STATUS+port,&regData);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortForceLinkExt(struct phy_device *phydev, rtk_uint32 id, rtl8367c_port_ability_t *pPortAbility)
{
    ...
    if (1 == type)
    {
        if(1 == id)
        {
            if ((retVal = rtl8367c_getAsicReg(phydev, RTL8367C_REG_REG_TO_ECO4, &regValue)) != RT_ERR_OK)
                return retVal;
            ...
            if((retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_SDS_MISC, RTL8367C_CFG_SGMII_FDUP_OFFSET, pPortAbility->duplex)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_SDS_MISC, RTL8367C_CFG_SGMII_SPD_MASK, pPortAbility->speed)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_SDS_MISC, RTL8367C_CFG_SGMII_LINK_OFFSET, pPortAbility->link)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_SDS_MISC, RTL8367C_CFG_SGMII_TXFC_OFFSET, pPortAbility->txpause)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_SDS_MISC, RTL8367C_CFG_SGMII_RXFC_OFFSET, pPortAbility->rxpause)) != RT_ERR_OK)
                return retVal;
        }

        if(0 == id || 1 == id)
            return rtl8367c_setAsicReg(phydev, RTL8367C_REG_DIGITAL_INTERFACE0_FORCE + id, reg_data);
        else
            return rtl8367c_setAsicReg(phydev, RTL8367C_REG_DIGITAL_INTERFACE2_FORCE, reg_data);
    }
    else if (2 == type)
    {
        if (1 == id)
        {
             if((retVal = rtl8367c_setAsicRegBit(phydev, 0x1311, 2, pPortAbility->duplex)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBits(phydev, 0x1311, 0x3, pPortAbility->speed)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBit(phydev, 0x1311, 4, pPortAbility->link)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBit(phydev, 0x1311, 6, pPortAbility->txpause)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBit(phydev, 0x1311, 5, pPortAbility->rxpause)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBit(phydev, 0x1311, 12, pPortAbility->forcemode)) != RT_ERR_OK)
                return retVal;

            if (pPortAbility->link == 1)
            {
                if((retVal = rtl8367c_setAsicRegBit(phydev, 0x1311, 4, 0)) != RT_ERR_OK)
                    return retVal;

                if((retVal = rtl8367c_setAsicRegBit(phydev, 0x1311, 4, 1)) != RT_ERR_OK)
                    return retVal;
            }
            else
            {
                if((retVal = rtl8367c_setAsicRegBits(phydev, 0x1311, 0x3, 2)) != RT_ERR_OK)
                    return retVal;
            }
        ...
        {
            if((retVal = rtl8367c_setAsicRegBit(phydev, 0x13c4, 2, pPortAbility->duplex)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBits(phydev, 0x13c4, 0x3, pPortAbility->speed)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBit(phydev, 0x13c4, 4, pPortAbility->link)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBit(phydev, 0x13c4, 6, pPortAbility->txpause)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBit(phydev, 0x13c4, 5, pPortAbility->rxpause)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBit(phydev, 0x13c4, 12, pPortAbility->forcemode)) != RT_ERR_OK)
                return retVal;

            if (pPortAbility->link == 1)
            {
                if((retVal = rtl8367c_setAsicRegBit(phydev, 0x13c4, 4, 0)) != RT_ERR_OK)
                    return retVal;

                if((retVal = rtl8367c_setAsicRegBit(phydev, 0x13c4, 4, 1)) != RT_ERR_OK)
                    return retVal;
            }
            else
            {
                if((retVal = rtl8367c_setAsicRegBits(phydev, 0x13c4, 0x3, 2)) != RT_ERR_OK)
                    return retVal;
            }

            if((retVal = rtl8367c_setAsicRegBit(phydev, 0x1dc1, RTL8367C_CFG_SGMII_FDUP_OFFSET, pPortAbility->duplex)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBits(phydev, 0x1dc1, RTL8367C_CFG_SGMII_SPD_MASK, pPortAbility->speed)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBit(phydev, 0x1dc1, RTL8367C_CFG_SGMII_LINK_OFFSET, pPortAbility->link)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBit(phydev, 0x1dc1, RTL8367C_CFG_SGMII_TXFC_OFFSET, pPortAbility->txpause)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBit(phydev, 0x1dc1, RTL8367C_CFG_SGMII_RXFC_OFFSET, pPortAbility->rxpause)) != RT_ERR_OK)
                return retVal;
        }
    ...
    else if(3 == type)
    {
        if(1 == id)
        {
            if((retVal = rtl8367c_getAsicRegBit(phydev, 0x1d11, 6, &sgmiibit)) != RT_ERR_OK)
                return retVal;
            if((retVal = rtl8367c_getAsicRegBit(phydev, 0x1d11, 11, &hisgmiibit)) != RT_ERR_OK)
                return retVal;

            if ((sgmiibit == 1) || (hisgmiibit == 1))
            {
                /*for 1000x/100fx/1000x_100fx, param has to be set to serdes registers*/
                if((retVal = rtl8367c_getAsicReg(phydev, 0x1d41, &regValue)) != RT_ERR_OK)
                    return retVal;
                ...
                {
                     /* new_cfg_sds_mode */
                    if((retVal = rtl8367c_getAsicRegBits(phydev, 0x1d95, 0x1f00, &regValue2)) != RT_ERR_OK)
                        return retVal;
                    ...
                    if(regValue2 == 0x4)
                    {
                        ...
                        if((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d95, 0x1f00, 0x1f)) != RT_ERR_OK)
                            return retVal;
#endif
                        /* Enable new sds mode config */
                        if((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d95, 13, 1)) != RT_ERR_OK)
                            return retVal;

                        /* 0 4 0  bit 12  set 1,  bit15~13 = 4*/
                        if((retVal = rtl8367c_getAsicSdsReg(phydev, 0, 4, 0, &reg_data)) != RT_ERR_OK)
                            return retVal;
                        reg_data &= 0xFFFF0FFF;
                        reg_data |= 0x9000;
                        if((retVal = rtl8367c_setAsicSdsReg(phydev, 0,4,0, reg_data)) != RT_ERR_OK)
                            return retVal;

                        /* 0 0 2  bit 6  set 1,  bit13 set to 0, bit12 nway_en*/
                        if((retVal = rtl8367c_getAsicSdsReg(phydev, 0, 0, 2, &reg_data)) != RT_ERR_OK)
                            return retVal;
                        reg_data &= 0xFFFFDFFF;
                        reg_data |= 0x40;
                        ...
                        if((retVal = rtl8367c_setAsicSdsReg(phydev, 0,0,2, reg_data)) != RT_ERR_OK)
                            return retVal;

                        /* 0 4 2  bit 8  rx pause,  bit7 tx pause*/
                        if((retVal = rtl8367c_getAsicSdsReg(phydev, 0, 4, 2, &reg_data)) != RT_ERR_OK)
                            return retVal;
                        ...
                        if((retVal = rtl8367c_setAsicSdsReg(phydev, 0,4,2, reg_data)) != RT_ERR_OK)
                            return retVal;
                        ...
                        if((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d95, 0x1f00, 0x4)) != RT_ERR_OK)
                            return retVal;
                    ...
                    else if(regValue2 == 0x5)
                    {
                        ...
                        if((retVal = rtl8367c_setAsicSdsReg(phydev, 0,4,0, reg_data)) != RT_ERR_OK)
                            return retVal;
                       /* new_cfg_sds_mode=1000x */
                        if((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d95, 0x1f00, 0x5)) != RT_ERR_OK)
                            return retVal;
                    ...
                    else if(regValue2 == 0x7)
                    {
                        ...
                        if((retVal = rtl8367c_setAsicSdsReg(phydev, 0,4,0, reg_data)) != RT_ERR_OK)
                            return retVal;
                        /*sds_mode:*/
                        if((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d95, 0x1f00, 0x7)) != RT_ERR_OK)
                            return retVal;

                    }

                    /*disable force ability   ---      */
                    if((retVal = rtl8367c_setAsicRegBit(phydev, 0x137c, 12, 0)) != RT_ERR_OK)
                        return retVal;
                    return RT_ERR_OK;
                ...
                if(regValue2 == 0x2)
                {
                    ...
                    /* 0 2 0  bit 8-9  nway*/
                    if((retVal = rtl8367c_getAsicSdsReg(phydev, 0, 2, 0, &reg_data)) != RT_ERR_OK)
                        return retVal;
                    reg_data &= 0xfffffcff;
                    if (pPortAbility->nway)
                        ...
                        reg_data |= 0x100;
                    if((retVal = rtl8367c_setAsicSdsReg(phydev, 0,2,0, reg_data)) != RT_ERR_OK)
                        return retVal;

                    if((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d95, 0x1f00, 0x2)) != RT_ERR_OK)
                        return retVal;
                ...
                else if(regValue2 == 0x12)
                {
                    ...
                    if((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d95, 0x1f00, 0x12)) != RT_ERR_OK)
                        return retVal;

                    for(i=0;i<0xfff; i++);

                    if((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d11, 11, 0x1)) != RT_ERR_OK)
                        return retVal;
            ...
            {
                if((retVal = rtl8367c_getAsicRegBits(phydev, 0x1d3d, 10, &regValue2)) != RT_ERR_OK)
                    return retVal;
                if (regValue2 == 0)
                {
                    /*ext1_force_ablty*/
        ...
        else if (2 == id)
        {
            ...
            if((retVal = rtl8367c_getAsicRegBit(phydev, 0x1d95, 0, &sgmiibit)) != RT_ERR_OK)
                    return retVal;
            if (sgmiibit == 1)
            {
                /*for 1000x/100fx/1000x_100fx, param has to bet set to serdes registers*/
                if((retVal = rtl8367c_getAsicReg(phydev, 0x1d95, &regValue)) != RT_ERR_OK)
                    return retVal;
                ...
                if((regValue & 0x3) == 0x3)
                {
                    ...
                    if((retVal = rtl8367c_setAsicRegBit(phydev, 0x137d, 12, 0)) != RT_ERR_OK)
                        return retVal;
                    return RT_ERR_OK;
            ...
            else
            {
                ...
                if((retVal = rtl8367c_getAsicRegBit(phydev, 0x1d3d, 10, &reg_data)) != RT_ERR_OK)
                        return retVal;
                if(reg_data == 1)
                {
                if((retVal = rtl8367c_setAsicRegBit(phydev, 0x1311, 2, pPortAbility->duplex)) != RT_ERR_OK)
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortForceLinkExt(struct phy_device *phydev, rtk_uint32 id, rtl8367c_port_ability_t *pPortAbility)
{
    ...
    if (1 == type)
    {
        if(1 == id)
        {
            if((retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_SDS_MISC, RTL8367C_CFG_MAC8_SEL_SGMII_OFFSET, &sgmiiSel)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_SDS_MISC, RTL8367C_CFG_MAC8_SEL_HSGMII_OFFSET, &hsgmiiSel)) != RT_ERR_OK)
                return retVal;
            ...
            if( (sgmiiSel == 1) || (hsgmiiSel == 1) )
            {
                ...
                if((retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_SDS_MISC, RTL8367C_CFG_SGMII_FDUP_OFFSET, &reg_data)) != RT_ERR_OK)
                    return retVal;

                pPortAbility->duplex = reg_data;

                if((retVal = rtl8367c_getAsicRegBits(phydev, RTL8367C_REG_SDS_MISC, RTL8367C_CFG_SGMII_SPD_MASK, &reg_data)) != RT_ERR_OK)
                    return retVal;

                pPortAbility->speed = reg_data;

                if((retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_SDS_MISC, RTL8367C_CFG_SGMII_LINK_OFFSET, &reg_data)) != RT_ERR_OK)
                    return retVal;

                pPortAbility->link = reg_data;

                if((retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_SDS_MISC, RTL8367C_CFG_SGMII_TXFC_OFFSET, &reg_data)) != RT_ERR_OK)
                    return retVal;

                pPortAbility->txpause = reg_data;

                if((retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_SDS_MISC, RTL8367C_CFG_SGMII_RXFC_OFFSET, &reg_data)) != RT_ERR_OK)
                    return retVal;
        ...
        if(0 == id || 1 == id)
            retVal = rtl8367c_getAsicReg(phydev, RTL8367C_REG_DIGITAL_INTERFACE0_FORCE+id, &reg_data);
        else
            retVal = rtl8367c_getAsicReg(phydev, RTL8367C_REG_DIGITAL_INTERFACE2_FORCE, &reg_data);
    ...
    else if (2 == type)
    {
        if (id == 1)
        {
            if ((retVal = rtl8367c_getAsicReg(phydev, 0x1311, &reg_data))!=RT_ERR_OK)
                return retVal;
        ...
        {
            if ((retVal = rtl8367c_getAsicReg(phydev, 0x13c4, &reg_data))!=RT_ERR_OK)
                return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortExtMode(struct phy_device *phydev, rtk_uint32 id, rtk_uint32 mode)
{
    ret_t   retVal;
    ...
    if (1==type)
    {
        ...
        {
            if((retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_REG_TO_ECO4, 5, 1)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_REG_TO_ECO4, 7, 1)) != RT_ERR_OK)
                return retVal;
            ...
            if(mode == EXT_1000X_100FX)
            {
                ...
                {
                    if ((retVal = rtl8367c_setAsicReg(phydev, 0xE000 + idx, (rtk_uint32)Fiber2_Auto[idx])) != RT_ERR_OK)
                        return retVal;
                }
            }
            ...
            if(mode == EXT_1000X)
            {
                ...
                {
                    if ((retVal = rtl8367c_setAsicReg(phydev, 0xE000 + idx, (rtk_uint32)Fiber2_1G[idx])) != RT_ERR_OK)
                        return retVal;
                }
            }
            ...
            if(mode == EXT_100FX)
            {
                ...
                {
                    if ((retVal = rtl8367c_setAsicReg(phydev, 0xE000 + idx, (rtk_uint32)Fiber2_100M[idx])) != RT_ERR_OK)
                        return retVal;
                }
            }
        ...
        if(mode == EXT_GMII)
        {
            if( (retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_EXT0_RGMXF, RTL8367C_EXT0_RGTX_INV_OFFSET, 1)) != RT_ERR_OK)
                return retVal;

            if( (retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_EXT1_RGMXF, RTL8367C_EXT1_RGTX_INV_OFFSET, 1)) != RT_ERR_OK)
                return retVal;

            if( (retVal = rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_EXT_TXC_DLY, RTL8367C_EXT1_GMII_TX_DELAY_MASK, 5)) != RT_ERR_OK)
                return retVal;

            if( (retVal = rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_EXT_TXC_DLY, RTL8367C_EXT0_GMII_TX_DELAY_MASK, 6)) != RT_ERR_OK)
                return retVal;
        }
        ...
        {
            if( (retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_BYPASS_LINE_RATE, id, 1)) != RT_ERR_OK)
                return retVal;
        }
        else
        {
            if( (retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_BYPASS_LINE_RATE, id, 0)) != RT_ERR_OK)
                return retVal;
        }
        ...
        if( (mode == EXT_SGMII) || (mode == EXT_HSGMII) )
        {
            ...
            if((retVal = rtl8367c_setAsicReg(phydev, 0x13C0, 0x0249)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_getAsicReg(phydev, 0x13C1, &option)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicReg(phydev, 0x13C0, 0x0000)) != RT_ERR_OK)
                return retVal;
        }
        ...
        if(mode == EXT_SGMII)
        {
            if(option == 0)
            {
                for(i = 0; i <= 7; i++)
                {
                    if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_DATA, redData[i][0])) != RT_ERR_OK)
                        return retVal;

                    if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_ADR, redData[i][1])) != RT_ERR_OK)
                        return retVal;
            ...
            else
            {
                for(i = 0; i <= 7; i++)
                {
                    if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_DATA, redDataSB[i][0])) != RT_ERR_OK)
                        return retVal;

                    if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_ADR, redDataSB[i][1])) != RT_ERR_OK)
                        return retVal;
        ...
        if(mode == EXT_HSGMII)
        {
            if(option == 0)
            {
                ...
                if ( ((regValue & 0x00F0) >> 4) == 0x0001)
                {
                    for(i = 0; i <= 8; i++)
                    {
                        if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_DATA, redData1[i][0])) != RT_ERR_OK)
                            return retVal;

                        if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_ADR, redData1[i][1])) != RT_ERR_OK)
                            return retVal;
                ...
                else if ( ((regValue & 0x00F0) >> 4) == 0x0005)
                {
                    for(i = 0; i <= 8; i++)
                    {
                        if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_DATA, redData5[i][0])) != RT_ERR_OK)
                            return retVal;

                        if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_ADR, redData5[i][1])) != RT_ERR_OK)
                            return retVal;
                ...
                else if ( ((regValue & 0x00F0) >> 4) == 0x0006)
                {
                    for(i = 0; i <= 8; i++)
                    {
                        if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_DATA, redData6[i][0])) != RT_ERR_OK)
                            return retVal;

                        if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_ADR, redData6[i][1])) != RT_ERR_OK)
                            return retVal;
                ...
                else if ( ((regValue & 0x00F0) >> 4) == 0x0008)
                {
                    for(i = 0; i <= 8; i++)
                    {
                        if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_DATA, redData8[i][0])) != RT_ERR_OK)
                            return retVal;

                        if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_ADR, redData8[i][1])) != RT_ERR_OK)
                            return retVal;
                ...
                else if ( ((regValue & 0x00F0) >> 4) == 0x0009)
                {
                    for(i = 0; i <= 8; i++)
                    {
                        if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_DATA, redData9[i][0])) != RT_ERR_OK)
                            return retVal;

                        if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_ADR, redData9[i][1])) != RT_ERR_OK)
                            return retVal;
            ...
            else
            {
                for(i = 0; i <= 8; i++)
                {
                    if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_DATA, redDataHB[i][0])) != RT_ERR_OK)
                        return retVal;

                    if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_ADR, redDataHB[i][1])) != RT_ERR_OK)
                        return retVal;
        ...
        if(id == 1)
        {
            ...
            if(mode == EXT_SGMII)
            {
                if( (retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_SDS_MISC, RTL8367C_CFG_MAC8_SEL_SGMII_OFFSET, 1)) != RT_ERR_OK)
                    return retVal;

                if( (retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_SDS_MISC, RTL8367C_CFG_MAC8_SEL_HSGMII_OFFSET, 0)) != RT_ERR_OK)
                    return retVal;
            }
            else if(mode == EXT_HSGMII)
            {
                if( (retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_SDS_MISC, RTL8367C_CFG_MAC8_SEL_SGMII_OFFSET, 0)) != RT_ERR_OK)
                    return retVal;

                if( (retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_SDS_MISC, RTL8367C_CFG_MAC8_SEL_HSGMII_OFFSET, 1)) != RT_ERR_OK)
                    return retVal;
            }
            else
            {
        ...
        if(0 == id || 1 == id)
        {
            if((retVal = rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_DIGITAL_INTERFACE_SELECT, RTL8367C_SELECT_GMII_0_MASK << (id * RTL8367C_SELECT_GMII_1_OFFSET), mode)) != RT_ERR_OK)
                return retVal;
        }
        else
        {
            if((retVal = rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_DIGITAL_INTERFACE_SELECT_1, RTL8367C_SELECT_GMII_2_MASK, mode)) != RT_ERR_OK)
                return retVal;
        }
        ...
        if( (mode == EXT_SGMII) || (mode == EXT_HSGMII) )
        {
            if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_DATA, 0x7106)) != RT_ERR_OK)
                return retVal;
        ...
        if( (mode == EXT_SGMII) || (mode == EXT_HSGMII) )
        {
            ...
            {
                if ((retVal = rtl8367c_setAsicReg(phydev, 0xE000 + idx, (rtk_uint32)Sgmii_Init[idx])) != RT_ERR_OK)
                    return retVal;
            }
    ...
    else if (2 == type)
    {
        ...
        if( (mode == EXT_TMII_MAC) || (mode == EXT_TMII_PHY) )
        {
            if( (retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_BYPASS_LINE_RATE, id+2, 1)) != RT_ERR_OK)
                return retVal;
        }
        else
        {
            if( (retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_BYPASS_LINE_RATE, id+2, 0)) != RT_ERR_OK)
                return retVal;
        }
        ...
        if (id == 1)
        {
            ...
            if (mode == EXT_SGMII)
            {
                ...
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1305, 0xf0, 0)) != RT_ERR_OK)
                    return retVal;

                /*enable port8 SGMII*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d92, 14, 1)) != RT_ERR_OK)
                    return retVal;
            }
            else if (mode == EXT_1000X || mode == EXT_100FX || mode == EXT_1000X_100FX)
            {
                ...
                /*disable port8 SGMII*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d92, 14, 0)) != RT_ERR_OK)
                    return retVal;

                /*set fiber link up*/
                if((retVal = rtl8367c_setAsicRegBit(phydev, 0x6210, 11, 0)) != RT_ERR_OK)
                    return retVal;
            }
            else
            {
                /*cfg port8 with MII mac mode*/
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1305, 0xf0, mode)) != RT_ERR_OK)
                    return retVal;
            ...
            /*disable SDS 1*/
            if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d92, 0x1f00, 0x1f)) != RT_ERR_OK)
                return retVal;
        }
        else if(id == 2)
        {
            if (mode == EXT_HSGMII)
            {
                if ((retVal = rtl8367c_setAsicReg(phydev, 0x130, 7)) != RT_ERR_OK)
                    return retVal;

                if ((retVal = rtl8367c_setAsicReg(phydev, 0x39f, 7)) != RT_ERR_OK)
                    return retVal;

                if ((retVal = rtl8367c_setAsicReg(phydev, 0x3fa, 7)) != RT_ERR_OK)
                    return retVal;
            }
            else
            {
                if ((retVal = rtl8367c_setAsicReg(phydev, 0x130, 1)) != RT_ERR_OK)
                    return retVal;

                if ((retVal = rtl8367c_setAsicReg(phydev, 0x39f, 1)) != RT_ERR_OK)
                    return retVal;

                if ((retVal = rtl8367c_setAsicReg(phydev, 0x3fa, 4)) != RT_ERR_OK)
                    return retVal;
            ...
            if (mode == EXT_SGMII)
            {
                ...
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x13c3, 0xf, 0)) != RT_ERR_OK)
                    return retVal;

                /*enable port9 SGMII*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d92, 6, 1)) != RT_ERR_OK)
                    return retVal;

                /*disable port9 HSGMII*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d92, 7, 0)) != RT_ERR_OK)
                    return retVal;
            }
            else if (mode == EXT_HSGMII)
            {
                ...
                /*disable port9 SGMII*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d92, 6, 0)) != RT_ERR_OK)
                    return retVal;

                /*enable port9 HSGMII*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d92, 7, 1)) != RT_ERR_OK)
                    return retVal;
            }
            else if (mode == EXT_1000X || mode == EXT_100FX || mode == EXT_1000X_100FX)
            {
                ...
                /*set fiber link up*/
                if((retVal = rtl8367c_setAsicRegBit(phydev, 0x6200, 11, 0)) != RT_ERR_OK)
                    return retVal;
            }
            else
            {
                /*cfg port9 with MII mac mode*/
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x13c3, 0xf, mode)) != RT_ERR_OK)
                    return retVal;
            ...
            /*disable SDS 0*/
            if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d92, 0x1f, 0x1f)) != RT_ERR_OK)
                return retVal;
        }
        ...
        if (mode == EXT_RGMII)
        {
            ...
            if ((retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_PARA_LED_IO_EN3, 0)) != RT_ERR_OK)
                return retVal;

            if ((retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_PARA_LED_IO_EN1, 0)) != RT_ERR_OK)
                return retVal;

            if ((retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_PARA_LED_IO_EN2, 0)) != RT_ERR_OK)
                return retVal;
            ...
            if (id == 1)
            {
                ...
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1303, 9, 1)) != RT_ERR_OK)
                    return retVal;

                /*drving 1*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1303, 6, 1)) != RT_ERR_OK)
                    return retVal;

                /*drving 1*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1303, 4, 1)) != RT_ERR_OK)
                    return retVal;

                /*show rate = 0*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1303, 1, 0)) != RT_ERR_OK)
                    return retVal;

                /*EXT1 RGMII TXC delay 2ns*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1307, 3, 1)) != RT_ERR_OK)
                    return retVal;
                ...
                /*RXDLY = 0*/
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1307, 0x7, 0)) != RT_ERR_OK)
                    return retVal;

                /*cfg_rg1_dn = 4*/
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1304, 0x7000, 4)) != RT_ERR_OK)
                    return retVal;

                /*cfg_rg1_dp = 4*/
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x13f9, 0x700, 4)) != RT_ERR_OK)
                    return retVal;
            }
            else if (id == 2)
            {
                ...
                /*drving 1*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x13e2, 2, 1)) != RT_ERR_OK)
                    return retVal;

                /*drving 1*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x13e2, 1, 1)) != RT_ERR_OK)
                    return retVal;

                /*show rate = 0*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x13e2, 0, 0)) != RT_ERR_OK)
                    return retVal;

                /*EXT1 RGMII TXC delay 2ns*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x13c5, 3, 1)) != RT_ERR_OK)
                    return retVal;
                ...
                /*RXDLY = 0*/
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x13c5, 0x7, 0)) != RT_ERR_OK)
                    return retVal;

                /*cfg_rg1_dn = 4*/
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x13e2, 0x1c0, 4)) != RT_ERR_OK)
                    return retVal;

                /*cfg_rg1_dp = 4*/
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x13e2, 0x38, 4)) != RT_ERR_OK)
                    return retVal;
            }
        }
        else if (mode == EXT_SGMII)
        {
            if (id == 1)
            {
                ...
                if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_DATA, 0xec91)) != RT_ERR_OK)
                    return retVal;

                if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_ADR, (0x21<<5) | 1)) != RT_ERR_OK)
                    return retVal;

                if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_CMD, 0x00C1)) != RT_ERR_OK)
                    return retVal;

                /*sds 1     reg 5    page 0x24     write value  0x5825*/
                if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_DATA, 0x5825)) != RT_ERR_OK)
                    return retVal;

                if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_ADR, (0x24<<5) | 5)) != RT_ERR_OK)
                    return retVal;

                if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_CMD, 0x00C1)) != RT_ERR_OK)
                    return retVal;

                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d92, 0x1f00, 2)) != RT_ERR_OK)
                    return retVal;
            ...
            else if (id == 2)
            {
                ...
                if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_DATA, 0x942c)) != RT_ERR_OK)
                    return retVal;

                if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_ADR, (0x28<<5) | 0)) != RT_ERR_OK)
                    return retVal;
                ...
                if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_ADR, (0x24<<5) | 0)) != RT_ERR_OK)
                    return retVal;
                ...
                if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_DATA, 0x8dc3)) != RT_ERR_OK)
                    return retVal;

                if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_ADR, (0x21<<5) | 5)) != RT_ERR_OK)
                    return retVal;

                if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_CMD, 0x00C0)) != RT_ERR_OK)
                    return retVal;

                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d92, 0x1f, 2)) != RT_ERR_OK)
                    return retVal;
        ...
        else if (mode == EXT_HSGMII)
        {
            if (id == 2)
            {
                ...
                if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_DATA, 0x3931)) != RT_ERR_OK)
                        return retVal;

                if( (retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_SDS_INDACS_ADR, (0x21<<5)|9) ) != RT_ERR_OK)
                        return retVal;
                ...
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d92, 0x1f, 0x12)) != RT_ERR_OK)
                    return retVal;
        ...
        else if (mode == EXT_1000X)
        {
            if (id == 1)
            {
                ...
                if( (retVal = rtl8367c_setAsicSdsReg(phydev, 1, 1, 0x21, 0xec91)) != RT_ERR_OK)
                    return retVal;
                if( (retVal = rtl8367c_setAsicSdsReg(phydev, 1, 5, 0x24, 0x5825)) != RT_ERR_OK)
                    return retVal;
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d92, 0x1f00, 4)) != RT_ERR_OK)
                    return retVal;
                ...
                if( (retVal = rtl8367c_getAsicSdsReg(phydev, 1, 4, 0, &regValue)) != RT_ERR_OK)
                    return retVal;
                regValue &= 0xFFFF0FFF;
                regValue |= 0x9000;
                if( (retVal = rtl8367c_setAsicSdsReg(phydev, 1, 4, 0, regValue)) != RT_ERR_OK)
                    return retVal;

                if( (retVal = rtl8367c_getAsicSdsReg(phydev, 1, 0, 2, &regValue)) != RT_ERR_OK)
                    return retVal;
                regValue &= 0xFFFFdFFF;
                regValue |= 0x40;
                if( (retVal = rtl8367c_setAsicSdsReg(phydev, 1, 0, 2, regValue)) != RT_ERR_OK)
                    return retVal;
                ...
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d92, 0x1f00, 4)) != RT_ERR_OK)
                    return retVal;
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d92, 0x6000, 0)) != RT_ERR_OK)
                    return retVal;

            }
            else if (id == 2)
            {
                if( (retVal = rtl8367c_setAsicSdsReg(phydev, 0, 0, 0x28, 0x942c)) != RT_ERR_OK)
                    return retVal;
                if( (retVal = rtl8367c_setAsicSdsReg(phydev, 0, 0, 0x24, 0x942c)) != RT_ERR_OK)
                    return retVal;
                if( (retVal = rtl8367c_setAsicSdsReg(phydev, 0, 5, 0x21, 0x8dc3)) != RT_ERR_OK)
                    return retVal;

                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d92, 0x1f, 4)) != RT_ERR_OK)
                    return retVal;
                ...
                if( (retVal = rtl8367c_getAsicSdsReg(phydev, 0, 4, 0, &regValue)) != RT_ERR_OK)
                    return retVal;
                regValue &= 0xFFFF0FFF;
                regValue |= 0x9000;
                if( (retVal = rtl8367c_setAsicSdsReg(phydev, 0, 4, 0, regValue)) != RT_ERR_OK)
                    return retVal;

                if( (retVal = rtl8367c_getAsicSdsReg(phydev, 0, 0, 2, &regValue)) != RT_ERR_OK)
                    return retVal;
                regValue &= 0xFFFFDFFF;
                regValue |= 0x40;
                if( (retVal = rtl8367c_setAsicSdsReg(phydev, 0, 0, 2, regValue)) != RT_ERR_OK)
                    return retVal;
                ...
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d92, 0x1f, 4)) != RT_ERR_OK)
                    return retVal;
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d92, 0xe0, 0)) != RT_ERR_OK)
                    return retVal;
        ...
        else if (mode == EXT_100FX)
        {
            if (id == 1)
            {
                ...
                if( (retVal = rtl8367c_setAsicSdsReg(phydev, 1, 5, 0x24, 0x5825)) != RT_ERR_OK)
                    return retVal;
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d92, 0x1f00, 5)) != RT_ERR_OK)
                    return retVal;
                ...
                if( (retVal = rtl8367c_setAsicSdsReg(phydev, 1, 0, 2, regValue)) != RT_ERR_OK)
                    return retVal;
#if 0
                if( (retVal = rtl8367c_setAsicReg(phydev, 0x6214, 0x1a0)) != RT_ERR_OK)
                    return retVal;
#endif
                if( (retVal = rtl8367c_getAsicSdsReg(phydev, 1, 4, 0, &regValue)) != RT_ERR_OK)
                    return retVal;
            ...
            else if (id == 2)
            {
                ...
                if( (retVal = rtl8367c_setAsicSdsReg(phydev, 0, 5, 0x21, 0x8dc3)) != RT_ERR_OK)
                    return retVal;
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d92, 0x1f, 5)) != RT_ERR_OK)
                    return retVal;
        ...
        else if (mode == EXT_1000X_100FX)
        {
            if (id == 1)
            {
                ...
                if( (retVal = rtl8367c_setAsicSdsReg(phydev, 1, 5, 0x24, 0x5825)) != RT_ERR_OK)
                    return retVal;
                if( (retVal = rtl8367c_setAsicSdsReg(phydev, 1, 13, 0, 0x4616)) != RT_ERR_OK)
                    return retVal;
                if( (retVal = rtl8367c_setAsicSdsReg(phydev, 1, 1, 0, 0xf20)) != RT_ERR_OK)
                    return retVal;
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d92, 0x1f00, 7)) != RT_ERR_OK)
                    return retVal;
            }
            else if (id == 2)
            {
                ...
                if( (retVal = rtl8367c_setAsicSdsReg(phydev, 0, 5, 0x21, 0x8dc3)) != RT_ERR_OK)
                    return retVal;
                if( (retVal = rtl8367c_setAsicSdsReg(phydev, 0, 13, 0, 0x4616)) != RT_ERR_OK)
                    return retVal;
                if( (retVal = rtl8367c_setAsicSdsReg(phydev, 0, 1, 0, 0xf20)) != RT_ERR_OK)
                    return retVal;
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d92, 0x1f, 7)) != RT_ERR_OK)
                    return retVal;
            }
        }
    ...
    else if (3 == type)
    {
        ...
        if( (retVal = rtl8367c_getAsicSdsReg(phydev, 0, 1, 1, &regValue)) != RT_ERR_OK)
            return retVal;
        regValue &= 0xFFFFFFEF;
        if( (retVal = rtl8367c_setAsicSdsReg(phydev, 0, 1, 1, regValue)) != RT_ERR_OK)
            return retVal;
        ...
        if (1 == id)
        {
            ...
            if ((retVal = rtl8367c_setAsicReg(phydev, 0x137c, 0x1000)) != RT_ERR_OK)
                    return retVal;

            if ((retVal = rtl8367c_getAsicRegBit(phydev, 0x1d9d, 6, &reg_data)) != RT_ERR_OK)
                    return retVal;
            while(reg_data == 0)
            {
                if ((retVal = rtl8367c_getAsicRegBit(phydev, 0x1d9d, 6, &reg_data)) != RT_ERR_OK)
            ...
            if (mode == EXT_SGMII)
            {
                ...
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x3f7, 1, 0)) != RT_ERR_OK)
                    return retVal;



                /*bit5: cfg_mac6_fib=0    &   bit7: cfg_mac6_fib2=0*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d41, 5, 0)) != RT_ERR_OK)
                    return retVal;
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d41, 7, 0)) != RT_ERR_OK)
                    return retVal;

                /*cfg_mac7_fib=0*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d95, 1, 0)) != RT_ERR_OK)
                    return retVal;

                /*cfg_mac7_sel_sgmii= 0: MAC7 is not SGMII mode*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d95, 0, 0)) != RT_ERR_OK)
                    return retVal;

                /*#cfg_sgmii_link=0*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d11, 9, 0)) != RT_ERR_OK)
                    return retVal;

                /*cfg_mac6_sel_hsgmii=0*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d11, 11, 0)) != RT_ERR_OK)
                    return retVal;
                ...
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d11, 6, 1)) != RT_ERR_OK)
                    return retVal;
                ...
                /* MAC link source*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d95, 2, 0)) != RT_ERR_OK)
                    return retVal;
            ...
            else if (mode == EXT_HSGMII)
            {
                ...
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d11, 11, 1)) != RT_ERR_OK)
                    return retVal;

                /*cfg_mac6_sel_sgmii= 0*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d11, 6, 0)) != RT_ERR_OK)
                    return retVal;

                if ((retVal = rtl8367c_setAsicReg(phydev, 0xd0,7)) != RT_ERR_OK)
                    return retVal;
                if ((retVal = rtl8367c_setAsicReg(phydev, 0x399, 7)) != RT_ERR_OK)
                    return retVal;
                if ((retVal = rtl8367c_setAsicReg(phydev, 0x3fa, 7)) != RT_ERR_OK)
                    return retVal;
            ...
            else if(mode == EXT_1000X)
            {
                ...
                if ((retVal = rtl8367c_setAsicReg(phydev, 0x1d11, 0x1500)) != RT_ERR_OK)
                    return retVal;
                ...
                */
                ...
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d95, 13, 1)) != RT_ERR_OK)
                    return retVal;
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d95, 3, 0)) != RT_ERR_OK)
                    return retVal;
                ...
                if ((retVal = rtl8367c_setAsicReg(phydev, 0x13eb, 0x15bb)) != RT_ERR_OK)
                    return retVal;

                /*bit3:  Serdes force mode:cfg_sds_frc_mode=1
                  bit[2:0]: Serdes chip mode, cfg_sds_mode=3b'100 (force sds FIB1G mode) */
                if ((retVal = rtl8367c_setAsicReg(phydev, 0x13e7, 0xc)) != RT_ERR_OK)
                    return retVal;


                /*bit5: cfg_mac6_fib=1 & bit7: cfg_mac6_fib2=1*/
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d41, 5, 1)) != RT_ERR_OK)
                    return retVal;
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d41, 7, 1)) != RT_ERR_OK)
                    return retVal;
            ...
            else if(mode == EXT_1000X_100FX)
            {
                ...
                */
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d95, 0x1f00, 0x1f)) != RT_ERR_OK)
                    return retVal;
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d95, 13, 0)) != RT_ERR_OK)
                    return retVal;
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d95, 3, 0)) != RT_ERR_OK)
                    return retVal;
            ...
            {
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d3d, 10, 0)) != RT_ERR_OK)
                    return retVal;
                ...
                {
                    /*!!!!!!*/
                    if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1305, 0xf0, 7)) != RT_ERR_OK)
                        return retVal;
                }
                else if(mode == EXT_RMII_PHY)
                {
                    if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1305, 0xf0, 8)) != RT_ERR_OK)
                        return retVal;
                }

                if ((mode == EXT_TMII_MAC) || (mode == EXT_TMII_PHY))
                {
                    if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x3f7, 1, 1)) != RT_ERR_OK)
                        return retVal;
                }
            }
        ...
        else if (2 == id)
        {
            ...
            if ((retVal = rtl8367c_setAsicReg(phydev, 0x137d, 0x1000)) != RT_ERR_OK)
                    return retVal;

            if ((retVal = rtl8367c_getAsicRegBit(phydev, 0x1d9d, 7, &reg_data)) != RT_ERR_OK)
                    return retVal;
            while(reg_data == 0)
            {
                if ((retVal = rtl8367c_getAsicRegBit(phydev, 0x1d9d, 7, &reg_data)) != RT_ERR_OK)
            ...
            if (mode == EXT_SGMII)
            {
                ...
                if ((retVal = rtl8367c_setAsicReg(phydev, 0x13c4, 0)) != RT_ERR_OK)
                    return retVal;
                /*  disable mac7  mode_ext2  */
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x3f7, 2, 0)) != RT_ERR_OK)
                    return retVal;
                ...
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d95, 0, 1)) != RT_ERR_OK)
                    return retVal;
            ...
            else if (mode == EXT_1000X)
            {
                ...
                /*cfg_mac7_sel_sgmii= 1 & cfg_mac7_fib=1*/
                if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1d95, 3, 3)) != RT_ERR_OK)
                    return retVal;
            ...
            else if (mode < EXT_SGMII)
            {
                ...
                if ((retVal = rtl8367c_setAsicReg(phydev, 0x1d95, 0x1f00)) != RT_ERR_OK)
                    return retVal;
                ...
                if ((mode == EXT_TMII_MAC) || (mode == EXT_TMII_PHY))
                {
                    if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x3f7, 2, 1)) != RT_ERR_OK)
                        return retVal;
                }
            ...
            else if ((mode < EXT_END) && (mode > EXT_100FX))
            {
                ...
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d3d, 10, 1)) != RT_ERR_OK)
                    return retVal;

                if ((retVal = rtl8367c_getAsicRegBit(phydev, 0x1d11, 11, &reg_data)) != RT_ERR_OK)
                    return retVal;
                if(reg_data == 0)
                {
                    if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x1d11, 6, 1)) != RT_ERR_OK)
                ...
                {
                    if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1305, 0xf0, (mode-13))) != RT_ERR_OK)
                        return retVal;
                }
                else
                {
                    if ((retVal = rtl8367c_setAsicRegBits(phydev, 0x1305, 0xf0, (mode-12))) != RT_ERR_OK)
                        return retVal;
                }
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortExtMode(struct phy_device *phydev, rtk_uint32 id, rtk_uint32 *pMode)
{
    ret_t   retVal;
    ...
    if (1 == type)
    {
        ...
        if (1 == id)
        {
            if( (retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_SDS_MISC, RTL8367C_CFG_MAC8_SEL_SGMII_OFFSET, &regData)) != RT_ERR_OK)
                return retVal;
            ...
            if( (retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_SDS_MISC, RTL8367C_CFG_MAC8_SEL_HSGMII_OFFSET, &regData)) != RT_ERR_OK)
                return retVal;
        ...
        if(0 == id || 1 == id)
            return rtl8367c_getAsicRegBits(phydev, RTL8367C_REG_DIGITAL_INTERFACE_SELECT, RTL8367C_SELECT_GMII_0_MASK << (id * RTL8367C_SELECT_GMII_1_OFFSET), pMode);
        else
           return rtl8367c_getAsicRegBits(phydev, RTL8367C_REG_DIGITAL_INTERFACE_SELECT_1, RTL8367C_SELECT_GMII_2_MASK, pMode);
    ...
    else if (2 == type)
    {
        if (1 == id)
        {
            if ((retVal = rtl8367c_getAsicReg(phydev, 0x1d92, &regData))!=RT_ERR_OK)
                return retVal;
            ...
            return rtl8367c_getAsicRegBits(phydev, 0x1305, 0xf0, pMode);
        }
        else if (2 == id)
        {
#if 0
            if ((retVal = rtl8367c_getAsicRegBit(phydev, 0x1d92, 6, &regData))!=RT_ERR_OK)
                return retVal;
            ...
            if ((retVal = rtl8367c_getAsicRegBit(phydev, 0x1d92, 7, &regData))!=RT_ERR_OK)
                return retVal;
            ...
            return rtl8367c_getAsicRegBits(phydev, 0x1305, 0xf, pMode);
        }
    }
    else if(3 == type)
    {
        ...
        {
            /* SDS_CFG_NEW */
            if ((retVal = rtl8367c_getAsicReg(phydev, 0x1d95, &regData))!=RT_ERR_OK)
                return retVal;
            ...
            if ((retVal = rtl8367c_getAsicReg(phydev, 0x1d11, &regData))!=RT_ERR_OK)
                return retVal;
            ...
            else
            {
                ...
                if ((retVal = rtl8367c_getAsicRegBits(phydev, 0x1305, 0xf0, &regData))!=RT_ERR_OK)
                    return retVal;
        ...
        else if (2 == id)
        {
            ...
            /* check port7 MAC mode */
                if ((retVal = rtl8367c_getAsicRegBits(phydev, 0x13c3, 0xf, &regData))!=RT_ERR_OK)
                    return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortEnableAll(struct phy_device *phydev, rtk_uint32 enable)
{
    if(enable >= 2)
        return RT_ERR_INPUT;

    return rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_PHY_AD, RTL8367C_PDNPHY_OFFSET, !enable);
}
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortEnableAll(struct phy_device *phydev, rtk_uint32 *pEnable)
{
    ret_t retVal;
    rtk_uint32 regData;

    retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_PHY_AD, RTL8367C_PDNPHY_OFFSET, &regData);
    if(retVal !=  RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortSmallIpg(struct phy_device *phydev, rtk_uint32 port, rtk_uint32 enable)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;

    return rtl8367c_setAsicRegBit(phydev, RTL8367C_PORT_SMALL_IPG_REG(port), RTL8367C_PORT0_MISC_CFG_SMALL_TAG_IPG_OFFSET, enable);
}
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortSmallIpg(struct phy_device *phydev, rtk_uint32 port, rtk_uint32* pEnable)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;

    return rtl8367c_getAsicRegBit(phydev, RTL8367C_PORT_SMALL_IPG_REG(port), RTL8367C_PORT0_MISC_CFG_SMALL_TAG_IPG_OFFSET, pEnable);
}
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortLoopback(struct phy_device *phydev, rtk_uint32 port, rtk_uint32 enable)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;

    return rtl8367c_setAsicRegBit(phydev, RTL8367C_PORT_MISC_CFG_REG(port), RTL8367C_PORT0_MISC_CFG_MAC_LOOPBACK_OFFSET, enable);
}
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortLoopback(struct phy_device *phydev, rtk_uint32 port, rtk_uint32 *pEnable)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;

    return rtl8367c_getAsicRegBit(phydev, RTL8367C_PORT_MISC_CFG_REG(port), RTL8367C_PORT0_MISC_CFG_MAC_LOOPBACK_OFFSET, pEnable);
}
 ...
 */
ret_t rtl8367c_setAsicPortRTCTEnable(struct phy_device *phydev, rtk_uint32 portmask)
{
    ret_t       retVal;
    rtk_uint32  regData;
    rtk_uint32  port;
    ...
    for(port = 0; port <= 10 ; port++)
    {
        ...
        {
             if((retVal = rtl8367c_getAsicPHYOCPReg(phydev, port, 0xa422, &regData)) != RT_ERR_OK)
                 return retVal;

             regData &= 0x7FFF;
             if((retVal = rtl8367c_setAsicPHYOCPReg(phydev, port, 0xa422, regData)) != RT_ERR_OK)
                 return retVal;
 ...
 *      RTCT test takes 4.8 seconds at most.
 */
ret_t rtl8367c_setAsicPortRTCTDisable(struct phy_device *phydev, rtk_uint32 portmask)
{
    ret_t       retVal;
    rtk_uint32  regData;
    rtk_uint32  port;
 ...
 */
ret_t rtl8367c_getAsicPortRTCTResult(struct phy_device *phydev, rtk_uint32 port, rtl8367c_port_rtct_result_t *pResult)
{
    ret_t       retVal;
    ...
    if( (regData == 0x6367) )
    {
        ...
        {
            /* Channel A */
            if((retVal = rtl8367c_setAsicPHYOCPReg(phydev, port, 0xa436, 0x802a)) != RT_ERR_OK)
                return retVal;
            ...
            /* Channel B */
            if((retVal = rtl8367c_setAsicPHYOCPReg(phydev, port, 0xa436, 0x802e)) != RT_ERR_OK)
                return retVal;
            ...
            /* Channel C */
            if((retVal = rtl8367c_setAsicPHYOCPReg(phydev, port, 0xa436, 0x8032)) != RT_ERR_OK)
                return retVal;
            ...
            /* Channel D */
            if((retVal = rtl8367c_setAsicPHYOCPReg(phydev, port, 0xa436, 0x8036)) != RT_ERR_OK)
                return retVal;
            ...
            /* Channel A Length */
            if((retVal = rtl8367c_setAsicPHYOCPReg(phydev, port, 0xa436, 0x802c)) != RT_ERR_OK)
                return retVal;
            ...
            /* Channel B Length */
            if((retVal = rtl8367c_setAsicPHYOCPReg(phydev, port, 0xa436, 0x8030)) != RT_ERR_OK)
                return retVal;
            ...
            /* Channel C Length */
            if((retVal = rtl8367c_setAsicPHYOCPReg(phydev, port, 0xa436, 0x8034)) != RT_ERR_OK)
                return retVal;
            ...
            /* Channel D Length */
            if((retVal = rtl8367c_setAsicPHYOCPReg(phydev, port, 0xa436, 0x8038)) != RT_ERR_OK)
                return retVal;
    ...
    else if(regData == 0x6368)
    {
        ...
        {
            /* Channel A */
            if((retVal = rtl8367c_setAsicPHYOCPReg(phydev, port, 0xa436, 0x802b)) != RT_ERR_OK)
                return retVal;
            ...
            /* Channel B */
            if((retVal = rtl8367c_setAsicPHYOCPReg(phydev, port, 0xa436, 0x802f)) != RT_ERR_OK)
                return retVal;
            ...
            /* Channel C */
            if((retVal = rtl8367c_setAsicPHYOCPReg(phydev, port, 0xa436, 0x8033)) != RT_ERR_OK)
                return retVal;
            ...
            /* Channel D */
            if((retVal = rtl8367c_setAsicPHYOCPReg(phydev, port, 0xa436, 0x8037)) != RT_ERR_OK)
                return retVal;
            ...
            /* Channel A Length */
            if((retVal = rtl8367c_setAsicPHYOCPReg(phydev, port, 0xa436, 0x802d)) != RT_ERR_OK)
                return retVal;
            ...
            /* Channel B Length */
            if((retVal = rtl8367c_setAsicPHYOCPReg(phydev, port, 0xa436, 0x8031)) != RT_ERR_OK)
                return retVal;
            ...
            /* Channel C Length */
            if((retVal = rtl8367c_setAsicPHYOCPReg(phydev, port, 0xa436, 0x8035)) != RT_ERR_OK)
                return retVal;
            ...
            /* Channel D Length */
            if((retVal = rtl8367c_setAsicPHYOCPReg(phydev, port, 0xa436, 0x8039)) != RT_ERR_OK)
                return retVal;
 ...
 *      None.
 */
ret_t rtl8367c_sdsReset(struct phy_device *phydev, rtk_uint32 id)
{
    ...
    if(option == 0)
    {
        if (1 == id)
        {
            if ((retVal = rtl8367c_getAsicRegBit(phydev, 0x130c, 5, &running))!=RT_ERR_OK)
                return retVal;

            if(running == 1)
            {
                if ((retVal = rtl8367c_setAsicRegBit(phydev, 0x130c, 5, 0))!=RT_ERR_OK)
                    return retVal;
            }

            retVal = rtl8367c_setAsicReg(phydev, 0x6601, 0x0000);

            if(retVal == RT_ERR_OK)
                retVal = rtl8367c_setAsicReg(phydev, 0x6602, 0x1401);

            if(retVal == RT_ERR_OK)
                retVal = rtl8367c_setAsicReg(phydev, 0x6600, 0x00C0);

            if(retVal == RT_ERR_OK)
                retVal = rtl8367c_setAsicReg(phydev, 0x6601, 0x0000);

            if(retVal == RT_ERR_OK)
                retVal = rtl8367c_setAsicReg(phydev, 0x6602, 0x1403);
            ...
            if(running == 1)
            {
                if ((retVal2 = rtl8367c_setAsicRegBit(phydev, 0x130c, 5, 1))!=RT_ERR_OK)
                    return retVal2;
            }
    ...
    else if(option == 1)
    {
        if (1 == id)
        {
            if((retVal = rtl8367c_getAsicReg(phydev, 0x1311, &state)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicReg(phydev, 0x1311, 0x66)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicReg(phydev, 0x1311, 0x1066)) != RT_ERR_OK)
                return retVal;

            while(1)
            {
                if((retVal = rtl8367c_getAsicReg(phydev, 0x1d9d, &regValue)) != RT_ERR_OK)
                    return retVal;
                if((regValue >> 8) & 1)
                    break;
            }
            ...
            if((retVal = rtl8367c_setAsicReg(phydev, 0x133d, 0x2)) != RT_ERR_OK)
                return retVal;

            for (i=0; i<0xffff; i++);

            if((retVal = rtl8367c_setAsicReg(phydev, 0x6601, 0x0)) != RT_ERR_OK)
                return retVal;
            if((retVal = rtl8367c_setAsicReg(phydev, 0x6602, 0x1401)) != RT_ERR_OK)
                return retVal;
            if((retVal = rtl8367c_setAsicReg(phydev, 0x6600, 0xc1)) != RT_ERR_OK)
                return retVal;
            if((retVal = rtl8367c_setAsicReg(phydev, 0x6601, 0x0)) != RT_ERR_OK)
                return retVal;
            if((retVal = rtl8367c_setAsicReg(phydev, 0x6602, 0x1403)) != RT_ERR_OK)
                return retVal;
            if((retVal = rtl8367c_setAsicReg(phydev, 0x6600, 0xc1)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicReg(phydev, 0x133d, 0x0)) != RT_ERR_OK)
                return retVal;

            for (i=0; i<0xffff; i++);

            if((retVal = rtl8367c_setAsicReg(phydev, 0x1311, state)) != RT_ERR_OK)
                return retVal;
        ...
        {
            if((retVal = rtl8367c_getAsicReg(phydev, 0x13c4, &state)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicReg(phydev, 0x13c4, 0x66)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367c_setAsicReg(phydev, 0x13c4, 0x1066)) != RT_ERR_OK)
                return retVal;
            ...
            if((retVal = rtl8367c_setAsicReg(phydev, 0x6602, 0x1401)) != RT_ERR_OK)
                return retVal;
            if((retVal = rtl8367c_setAsicReg(phydev, 0x6600, 0xc0)) != RT_ERR_OK)
                return retVal;
            if((retVal = rtl8367c_setAsicReg(phydev, 0x6601, 0x0)) != RT_ERR_OK)
                return retVal;
            if((retVal = rtl8367c_setAsicReg(phydev, 0x6602, 0x1403)) != RT_ERR_OK)
            ...
            if((retVal = rtl8367c_setAsicReg(phydev, 0x13c4, state)) != RT_ERR_OK)
                return retVal;
        }
        else
            return RT_ERR_PORT_ID;
    ...
    {
        if ((retVal = rtl8367c_getAsicSdsReg(phydev, 0, 3, 0, &regValue))!=RT_ERR_OK)
                  return retVal;
              regValue |= 0x40;
              if ((retVal = rtl8367c_setAsicSdsReg(phydev, 0, 3, 0, regValue))!=RT_ERR_OK)
                  return retVal;
 ...
 *      None.
 */
ret_t rtl8367c_getSdsLinkStatus(struct phy_device *phydev, rtk_uint32 ext_id, rtk_uint32 *pSignalDetect, rtk_uint32 *pSync, rtk_uint32 *pLink)
{
    ...
    if(type == 0)
    {
        if (1 == ext_id)
        {
            ...
            retVal = rtl8367c_setAsicReg(phydev, 0x6601, 0x003D);

            if(retVal == RT_ERR_OK)
                retVal = rtl8367c_setAsicReg(phydev, 0x6600, 0x0080);

            if(retVal == RT_ERR_OK)
                retVal = rtl8367c_getAsicReg(phydev, 0x6602, &regValue);
    ...
    else if(type == 1)
    {
        if (1 == ext_id)
        {
            if ((retVal = rtl8367c_setAsicReg(phydev, 0x6601, 0x003D))!=RT_ERR_OK)
                return retVal;
            if ((retVal = rtl8367c_setAsicReg(phydev, 0x6600, 0x0081))!=RT_ERR_OK)
                return retVal;
            if ((retVal = rtl8367c_getAsicReg(phydev, 0x6602, &regValue))!=RT_ERR_OK)
                return retVal;
        ...
        else if (2 == ext_id)
        {
            if ((retVal = rtl8367c_setAsicReg(phydev, 0x6601, 0x003D))!=RT_ERR_OK)
                return retVal;
            if ((retVal = rtl8367c_setAsicReg(phydev, 0x6600, 0x0080))!=RT_ERR_OK)
                return retVal;
            if ((retVal = rtl8367c_getAsicReg(phydev, 0x6602, &regValue))!=RT_ERR_OK)
                return retVal;
    ...
    {
        if((retVal = rtl8367c_getAsicSdsReg(phydev, 0, 30, 1, &regValue)) != RT_ERR_OK)
            return retVal;
        if((retVal = rtl8367c_getAsicSdsReg(phydev, 0, 30, 1, &regValue)) != RT_ERR_OK)
            return retVal;
 ...
 *      None.
 */
ret_t rtl8367c_setSgmiiNway(struct phy_device *phydev, rtk_uint32 ext_id, rtk_uint32 state)
{
    rtk_uint32 retVal, regValue, type, running = 0, retVal2;
    ...
    if(type == 0)
    {
        if (1 == ext_id)
        {
            ...
            retVal = rtl8367c_setAsicReg(phydev, 0x6601, 0x0002);
            ...
            if(retVal == RT_ERR_OK)
                retVal = rtl8367c_setAsicReg(phydev, 0x6602, regValue);
    ...
    else if(type == 1)
    {
        if (1 == ext_id)
        {
            if ((retVal = rtl8367c_setAsicReg(phydev, 0x6601, 0x0002))!=RT_ERR_OK)
                   return retVal;
            if ((retVal = rtl8367c_setAsicReg(phydev, 0x6600, 0x0081))!=RT_ERR_OK)
                   return retVal;
            if ((retVal = rtl8367c_getAsicReg(phydev, 0x6602, &regValue))!=RT_ERR_OK)
            ...
            if ((retVal = rtl8367c_setAsicReg(phydev, 0x6602, regValue))!=RT_ERR_OK)
                   return retVal;
            if ((retVal = rtl8367c_setAsicReg(phydev, 0x6601, 0x0002))!=RT_ERR_OK)
                   return retVal;
            if ((retVal = rtl8367c_setAsicReg(phydev, 0x6600, 0x00C1))!=RT_ERR_OK)
                   return retVal;
        }
        else if (2 == ext_id)
        {
            ...
            if ((retVal = rtl8367c_setAsicReg(phydev, 0x6601, 0x0002))!=RT_ERR_OK)
                return retVal;
            if ((retVal = rtl8367c_setAsicReg(phydev, 0x6600, 0x00C0))!=RT_ERR_OK)
                return retVal;
        }
        else
            return RT_ERR_PORT_ID;
    ...
    {
        if ((retVal = rtl8367c_getAsicSdsReg(phydev, 0, 2, 0, &regValue))!=RT_ERR_OK)
            return retVal;
        ...
        if ((retVal = rtl8367c_setAsicSdsReg(phydev, 0, 2, 0, regValue))!=RT_ERR_OK)
            return retVal;
    }
 ...
 *      None.
 */
ret_t rtl8367c_getSgmiiNway(struct phy_device *phydev, rtk_uint32 ext_id, rtk_uint32 *pState)
{
    rtk_uint32 retVal, regValue, type, running = 0, retVal2;
