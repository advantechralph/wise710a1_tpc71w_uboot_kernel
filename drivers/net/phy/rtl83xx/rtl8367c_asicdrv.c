 ...
 */
ret_t rtl8367c_setAsicRegBit(struct phy_device *phydev, rtk_uint32 reg, rtk_uint32 bit, rtk_uint32 value)
{
    ...
    retVal = smi_read(phydev, reg, &regData);
    if(retVal != RT_ERR_OK)
        return RT_ERR_SMI;
    ...
    retVal = smi_write(phydev, reg, regData);
    if(retVal != RT_ERR_OK)
        return RT_ERR_SMI;
 ...
 *      None
 */
ret_t rtl8367c_getAsicRegBit(struct phy_device *phydev, rtk_uint32 reg, rtk_uint32 bit, rtk_uint32 *pValue)
{
 ...
 */
ret_t rtl8367c_setAsicRegBits(struct phy_device *phydev, rtk_uint32 reg, rtk_uint32 bits, rtk_uint32 value)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRegBits(struct phy_device *phydev, rtk_uint32 reg, rtk_uint32 bits, rtk_uint32 *pValue)
{
 ...
 */
ret_t rtl8367c_setAsicReg(struct phy_device *phydev, rtk_uint32 reg, rtk_uint32 value)
{
    ...
    retVal = smi_write(phydev, reg, value);
    if(retVal != RT_ERR_OK)
        return RT_ERR_SMI;
  #ifdef CONFIG_RTL865X_CLE
    if(0x8367B == cleDebuggingDisplay)
 ...
 */
ret_t rtl8367c_getAsicReg(struct phy_device *phydev, rtk_uint32 reg, rtk_uint32 *pValue)
{
