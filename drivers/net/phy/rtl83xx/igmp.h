 ...
 *      This API enables H/W IGMP and set a default initial configuration.
 */
extern rtk_api_ret_t rtk_igmp_init(struct phy_device *phydev);
 ...
 *      This API set H/W IGMP state.
 */
extern rtk_api_ret_t rtk_igmp_state_set(struct phy_device *phydev, rtk_enable_t enabled);
 ...
 */
extern rtk_api_ret_t rtk_igmp_state_get(struct phy_device *phydev, rtk_enable_t *pEnabled);
 ...
 */
extern rtk_api_ret_t rtk_igmp_static_router_port_set(struct phy_device *phydev, rtk_portmask_t *pPortmask);
 ...
 */
extern rtk_api_ret_t rtk_igmp_static_router_port_get(struct phy_device *phydev, rtk_portmask_t *pPortmask);
 ...
 */
extern rtk_api_ret_t rtk_igmp_protocol_set(struct phy_device *phydev, rtk_port_t port, rtk_igmp_protocol_t protocol, rtk_igmp_action_t action);
 ...
 *      This API set IGMP/MLD protocol action
 */
extern rtk_api_ret_t rtk_igmp_protocol_get(struct phy_device *phydev, rtk_port_t port, rtk_igmp_protocol_t protocol, rtk_igmp_action_t *pAction);
 ...
 */
extern rtk_api_ret_t rtk_igmp_fastLeave_set(struct phy_device *phydev, rtk_enable_t state);
 ...
 */
extern rtk_api_ret_t rtk_igmp_fastLeave_get(struct phy_device *phydev, rtk_enable_t *pState);
 ...
 */
extern rtk_api_ret_t rtk_igmp_maxGroup_set(struct phy_device *phydev, rtk_port_t port, rtk_uint32 group);
 ...
 */
extern rtk_api_ret_t rtk_igmp_maxGroup_get(struct phy_device *phydev, rtk_port_t port, rtk_uint32 *pGroup);
 ...
 */
extern rtk_api_ret_t rtk_igmp_currentGroup_get(struct phy_device *phydev, rtk_port_t port, rtk_uint32 *pGroup);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_igmp_tableFullAction_set(struct phy_device *phydev, rtk_igmp_tableFullAction_t action);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_igmp_tableFullAction_get(struct phy_device *phydev, rtk_igmp_tableFullAction_t *pAction);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_igmp_checksumErrorAction_set(struct phy_device *phydev, rtk_igmp_checksumErrorAction_t action);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_igmp_checksumErrorAction_get(struct phy_device *phydev, rtk_igmp_checksumErrorAction_t *pAction);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_igmp_leaveTimer_set(struct phy_device *phydev, rtk_uint32 timer);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_igmp_leaveTimer_get(struct phy_device *phydev, rtk_uint32 *pTimer);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_igmp_queryInterval_set(struct phy_device *phydev, rtk_uint32 interval);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_igmp_queryInterval_get(struct phy_device *phydev, rtk_uint32 *pInterval);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_igmp_robustness_set(struct phy_device *phydev, rtk_uint32 robustness);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_igmp_robustness_get(struct phy_device *phydev, rtk_uint32 *pRobustness);
 ...
 *
 */
extern rtk_api_ret_t rtk_igmp_dynamicRouterPortAllow_set(struct phy_device *phydev, rtk_portmask_t *pPortmask);
 ...
 *
 */
extern rtk_api_ret_t rtk_igmp_dynamicRouterPortAllow_get(struct phy_device *phydev, rtk_portmask_t *pPortmask);
 ...
 *
 */
extern rtk_api_ret_t rtk_igmp_dynamicRouterPort_get(struct phy_device *phydev, rtk_igmp_dynamicRouterPort_t *pDynamicRouterPort);
 ...
 *
 */
extern rtk_api_ret_t rtk_igmp_suppressionEnable_set(struct phy_device *phydev, rtk_enable_t reportSuppression, rtk_enable_t leaveSuppression);
 ...
 *
 */
extern rtk_api_ret_t rtk_igmp_suppressionEnable_get(struct phy_device *phydev, rtk_enable_t *pReportSuppression, rtk_enable_t *pLeaveSuppression);
 ...
 *
 */
extern rtk_api_ret_t rtk_igmp_portRxPktEnable_set(struct phy_device *phydev, rtk_port_t port, rtk_igmp_rxPktEnable_t *pRxCfg);
 ...
 *
 */
extern rtk_api_ret_t rtk_igmp_portRxPktEnable_get(struct phy_device *phydev, rtk_port_t port, rtk_igmp_rxPktEnable_t *pRxCfg);
 ...
 *
 */
extern rtk_api_ret_t rtk_igmp_groupInfo_get(struct phy_device *phydev, rtk_uint32 index, rtk_igmp_groupInfo_t *pGroup);
 ...
 *
 */
extern rtk_api_ret_t rtk_igmp_ReportLeaveFwdAction_set(struct phy_device *phydev, rtk_igmp_ReportLeaveFwdAct_t action);
 ...
 *
 */
extern rtk_api_ret_t rtk_igmp_ReportLeaveFwdAction_get(struct phy_device *phydev, rtk_igmp_ReportLeaveFwdAct_t *pAction);
 ...
 *
 */
extern rtk_api_ret_t rtk_igmp_dropLeaveZeroEnable_set(struct phy_device *phydev, rtk_enable_t enabled);
 ...
 *
 */
extern rtk_api_ret_t rtk_igmp_dropLeaveZeroEnable_get(struct phy_device *phydev, rtk_enable_t *pEnabled);
 ...
 *
 */
extern rtk_api_ret_t rtk_igmp_bypassGroupRange_set(struct phy_device *phydev, rtk_igmp_bypassGroup_t group, rtk_enable_t enabled);
 ...
 *
 */
extern rtk_api_ret_t rtk_igmp_bypassGroupRange_get(struct phy_device *phydev, rtk_igmp_bypassGroup_t group, rtk_enable_t *pEnable);
