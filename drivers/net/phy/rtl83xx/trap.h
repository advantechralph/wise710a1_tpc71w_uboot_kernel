 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
extern rtk_api_ret_t rtk_trap_unknownMacPktAction_set(struct phy_device *phydev, rtk_trap_ucast_action_t ucast_action);
 ...
 *
 */
extern rtk_api_ret_t rtk_trap_unknownMacPktAction_get(struct phy_device *phydev, rtk_trap_ucast_action_t *pUcast_action);
 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
extern rtk_api_ret_t rtk_trap_unmatchMacPktAction_set(struct phy_device *phydev, rtk_trap_ucast_action_t ucast_action);
 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
extern rtk_api_ret_t rtk_trap_unmatchMacPktAction_get(struct phy_device *phydev, rtk_trap_ucast_action_t *pUcast_action);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_trap_unmatchMacMoving_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t enable);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_trap_unmatchMacMoving_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pEnable);
 ...
 *          - MCAST_ACTION_TRAP2CPU
 */
extern rtk_api_ret_t rtk_trap_unknownMcastPktAction_set(struct phy_device *phydev, rtk_port_t port, rtk_mcast_type_t type, rtk_trap_mcast_action_t mcast_action);
 ...
 *          - MCAST_ACTION_TRAP2CPU
 */
extern rtk_api_ret_t rtk_trap_unknownMcastPktAction_get(struct phy_device *phydev, rtk_port_t port, rtk_mcast_type_t type, rtk_trap_mcast_action_t *pMcast_action);
 ...
 */
extern rtk_api_ret_t rtk_trap_lldpEnable_set(struct phy_device *phydev, rtk_enable_t enabled);
 ...
 *      - 01:80:c2:00:00:00 ethertype = 0x88CC
 */
extern rtk_api_ret_t rtk_trap_lldpEnable_get(struct phy_device *phydev, rtk_enable_t *pEnabled);
 ...
 *      - TRAP_REASON_UNKNOWNMC
 */
extern rtk_api_ret_t rtk_trap_reasonTrapToCpuPriority_set(struct phy_device *phydev, rtk_trap_reason_type_t type, rtk_pri_t priority);
 ...
 *      - TRAP_REASON_UNKNOWNMC
 */
extern rtk_api_ret_t rtk_trap_reasonTrapToCpuPriority_get(struct phy_device *phydev, rtk_trap_reason_type_t type, rtk_pri_t *pPriority);
 ...
 *      - RMA_ACTION_FORWARD_EXCLUDE_CPU
 */
extern rtk_api_ret_t rtk_trap_rmaAction_set(struct phy_device *phydev, rtk_trap_type_t type, rtk_trap_rma_action_t rma_action);
 ...
 *      - RMA_ACTION_FORWARD_EXCLUDE_CPU
 */
extern rtk_api_ret_t rtk_trap_rmaAction_get(struct phy_device *phydev, rtk_trap_type_t type, rtk_trap_rma_action_t *pRma_action);
 ...
 *      - TRAP_LLDP.
 */
extern rtk_api_ret_t rtk_trap_rmaKeepFormat_set(struct phy_device *phydev, rtk_trap_type_t type, rtk_enable_t enable);
 ...
 *      - TRAP_LLDP.
 */
extern rtk_api_ret_t rtk_trap_rmaKeepFormat_get(struct phy_device *phydev, rtk_trap_type_t type, rtk_enable_t *pEnable);
