 ...
 */
extern rtk_api_ret_t rtk_vlan_init(struct phy_device *phydev);
 ...
 *
 */
extern rtk_api_ret_t rtk_vlan_set(struct phy_device *phydev, rtk_vlan_t vid, rtk_vlan_cfg_t *pVlanCfg);
 ...
 *
 */
extern rtk_api_ret_t rtk_vlan_get(struct phy_device *phydev, rtk_vlan_t vid, rtk_vlan_cfg_t *pVlanCfg);
 ...
 *
 */
extern rtk_api_ret_t rtk_vlan_egrFilterEnable_set(struct phy_device *phydev, rtk_enable_t egrFilter);
 ...
 *
 */
extern rtk_api_ret_t rtk_vlan_egrFilterEnable_get(struct phy_device *phydev, rtk_enable_t *pEgrFilter);
 ...
 *     Set a VLAN Member Configuration entry by index.
 */
extern rtk_api_ret_t rtk_vlan_mbrCfg_set(struct phy_device *phydev, rtk_uint32 idx, rtk_vlan_mbrcfg_t *pMbrcfg);
 ...
 *     Get a VLAN Member Configuration entry by index.
 */
extern rtk_api_ret_t rtk_vlan_mbrCfg_get(struct phy_device *phydev, rtk_uint32 idx, rtk_vlan_mbrcfg_t *pMbrcfg);
 ...
 */
extern rtk_api_ret_t rtk_vlan_portPvid_set(struct phy_device *phydev, rtk_port_t port, rtk_vlan_t pvid, rtk_pri_t priority);
 ...
 */
extern rtk_api_ret_t rtk_vlan_portPvid_get(struct phy_device *phydev, rtk_port_t port, rtk_vlan_t *pPvid, rtk_pri_t *pPriority);
 ...
 */
extern rtk_api_ret_t rtk_vlan_portIgrFilterEnable_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t igr_filter);
 ...
 *     - ENABLED
 */
extern rtk_api_ret_t rtk_vlan_portIgrFilterEnable_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pIgr_filter);
 ...
 */
extern rtk_api_ret_t rtk_vlan_portAcceptFrameType_set(struct phy_device *phydev, rtk_port_t port, rtk_vlan_acceptFrameType_t accept_frame_type);
 ...
 *     - ACCEPT_FRAME_TYPE_UNTAG_ONLY
 */
extern rtk_api_ret_t rtk_vlan_portAcceptFrameType_get(struct phy_device *phydev, rtk_port_t port, rtk_vlan_acceptFrameType_t *pAccept_frame_type);
 ...
 *      - VLAN_TAG_MODE_REAL_KEEP_FORMAT,
 */
extern rtk_api_ret_t rtk_vlan_tagMode_set(struct phy_device *phydev, rtk_port_t port, rtk_vlan_tagMode_t tag_mode);
 ...
 *      - VLAN_TAG_MODE_REAL_KEEP_FORMAT,
 */
extern rtk_api_ret_t rtk_vlan_tagMode_get(struct phy_device *phydev, rtk_port_t port, rtk_vlan_tagMode_t *pTag_mode);
 ...
 *      None.
 */
extern rtk_api_ret_t rtk_vlan_transparent_set(struct phy_device *phydev, rtk_port_t egr_port, rtk_portmask_t *pIgr_pmask);
 ...
 *      None.
 */
extern rtk_api_ret_t rtk_vlan_transparent_get(struct phy_device *phydev, rtk_port_t egr_port, rtk_portmask_t *pIgr_pmask);
 ...
 *      None.
 */
extern rtk_api_ret_t rtk_vlan_keep_set(struct phy_device *phydev, rtk_port_t egr_port, rtk_portmask_t *pIgr_pmask);
 ...
 *      None.
 */
extern rtk_api_ret_t rtk_vlan_keep_get(struct phy_device *phydev, rtk_port_t egr_port, rtk_portmask_t *pIgr_pmask);
 ...
 */
extern rtk_api_ret_t rtk_vlan_stg_set(struct phy_device *phydev, rtk_vlan_t vid, rtk_stp_msti_id_t stg);
 ...
 */
extern rtk_api_ret_t rtk_vlan_stg_get(struct phy_device *phydev, rtk_vlan_t vid, rtk_stp_msti_id_t *pStg);
 ...
 *      - FRAME_TYPE_LLCOTHER
 */
extern rtk_api_ret_t rtk_vlan_protoAndPortBasedVlan_add(struct phy_device *phydev, rtk_port_t port, rtk_vlan_protoAndPortInfo_t *pInfo);
 ...
 *      - FRAME_TYPE_LLCOTHER
 */
extern rtk_api_ret_t rtk_vlan_protoAndPortBasedVlan_get(struct phy_device *phydev, rtk_port_t port, rtk_vlan_proto_type_t proto_type, rtk_vlan_protoVlan_frameType_t frame_type, rtk_vlan_protoAndPortInfo_t *pInfo);
 ...
 *      - FRAME_TYPE_LLCOTHER
 */
extern rtk_api_ret_t rtk_vlan_protoAndPortBasedVlan_del(struct phy_device *phydev, rtk_port_t port, rtk_vlan_proto_type_t proto_type, rtk_vlan_protoVlan_frameType_t frame_type);
 ...
 */
extern rtk_api_ret_t rtk_vlan_protoAndPortBasedVlan_delAll(struct phy_device *phydev, rtk_port_t port);
 ...
 */
extern rtk_api_ret_t rtk_vlan_portFid_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t enable, rtk_fid_t fid);
 ...
 *      packets will be assigned to the port-based fid regardless vlan tag.
 */
extern rtk_api_ret_t rtk_vlan_portFid_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pEnable, rtk_fid_t *pFid);
 ...
 *
 */
extern rtk_api_ret_t rtk_vlan_UntagDscpPriorityEnable_set(struct phy_device *phydev, rtk_enable_t enable);
 ...
 *
 */
extern rtk_api_ret_t rtk_vlan_UntagDscpPriorityEnable_get(struct phy_device *phydev, rtk_enable_t *pEnable);
 ...
 *      - STP_STATE_FORWARDING
 */
extern rtk_api_ret_t rtk_stp_mstpState_set(struct phy_device *phydev, rtk_stp_msti_id_t msti, rtk_port_t port, rtk_stp_state_t stp_state);
 ...
 *      - STP_STATE_FORWARDING
 */
extern rtk_api_ret_t rtk_stp_mstpState_get(struct phy_device *phydev, rtk_stp_msti_id_t msti, rtk_port_t port, rtk_stp_state_t *pStp_state);
 ...
 *
 */
extern rtk_api_ret_t rtk_vlan_checkAndCreateMbr(struct phy_device *phydev, rtk_vlan_t vid, rtk_uint32 *pIndex);
 ...
 *
 */
extern rtk_api_ret_t rtk_vlan_reservedVidAction_set(struct phy_device *phydev, rtk_vlan_resVidAction_t action_vid0, rtk_vlan_resVidAction_t action_vid4095);
 ...
 *
 */
extern rtk_api_ret_t rtk_vlan_reservedVidAction_get(struct phy_device *phydev, rtk_vlan_resVidAction_t *pAction_vid0, rtk_vlan_resVidAction_t *pAction_vid4095);
 ...
 *
 */
extern rtk_api_ret_t rtk_vlan_realKeepRemarkEnable_set(struct phy_device *phydev, rtk_enable_t enabled);
 ...
 *
 */
extern rtk_api_ret_t rtk_vlan_realKeepRemarkEnable_get(struct phy_device *phydev, rtk_enable_t *pEnabled);
