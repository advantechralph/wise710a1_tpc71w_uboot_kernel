 ...
 */
extern rtk_api_ret_t rtk_oam_init(struct phy_device *phydev);
 ...
 *      This API set OAM state.
 */
extern rtk_api_ret_t rtk_oam_state_set(struct phy_device *phydev, rtk_enable_t enabled);
 ...
 */
extern rtk_api_ret_t rtk_oam_state_get(struct phy_device *phydev, rtk_enable_t *pEnabled);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_oam_parserAction_set(struct phy_device *phydev, rtk_port_t port, rtk_oam_parser_act_t action);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_oam_parserAction_get(struct phy_device *phydev, rtk_port_t port, rtk_oam_parser_act_t *pAction);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_oam_multiplexerAction_set(struct phy_device *phydev, rtk_port_t port, rtk_oam_multiplexer_act_t action);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_oam_multiplexerAction_get(struct phy_device *phydev, rtk_port_t port, rtk_oam_multiplexer_act_t *pAction);
