 ...
 *      None
 */
ret_t rtl8367c_setAsicAcl(struct phy_device *phydev, rtk_uint32 port, rtk_uint32 enabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;

    return rtl8367c_setAsicRegBit(phydev, RTL8367C_ACL_ENABLE_REG, port, enabled);
}
/* Function Name:
 *      rtl8367c_getAsicAcl
 * Description:
 ...
 *      None
 */
ret_t rtl8367c_getAsicAcl(struct phy_device *phydev, rtk_uint32 port, rtk_uint32* pEnabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;

    return rtl8367c_getAsicRegBit(phydev, RTL8367C_ACL_ENABLE_REG, port, pEnabled);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclUnmatchedPermit(struct phy_device *phydev, rtk_uint32 port, rtk_uint32 enabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;

    return rtl8367c_setAsicRegBit(phydev, RTL8367C_ACL_UNMATCH_PERMIT_REG, port, enabled);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclUnmatchedPermit(struct phy_device *phydev, rtk_uint32 port, rtk_uint32* pEnabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;

    return rtl8367c_getAsicRegBit(phydev, RTL8367C_ACL_UNMATCH_PERMIT_REG, port, pEnabled);
}
 ...
 */
ret_t rtl8367c_setAsicAclRule(struct phy_device *phydev, rtk_uint32 index, rtl8367c_aclrule* pAclRule)
{
    ...
    retVal = rtl8367c_setAsicRegBits(phydev, RTL8367C_TABLE_ACCESS_WRDATA_REG(RTL8367C_ACLRULETBLEN), 0x1, 0);
    if(retVal !=RT_ERR_OK)
        return retVal;
    ...
    retVal = rtl8367c_setAsicRegBits(phydev, RTL8367C_TABLE_ACCESS_WRDATA_REG(RTL8367C_ACLRULETBLEN), (0x0007 << 1), (aclRuleSmi.care_bits_ext.rule_info >> 1) & 0x0007);
    if(retVal != RT_ERR_OK)
        return retVal;
    ...
    retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_TABLE_ACCESS_WRDATA_REG(RTL8367C_ACLRULETBLEN), 0, aclRuleSmi.valid);
    if(retVal != RT_ERR_OK)
        return retVal;
    retVal = rtl8367c_setAsicRegBits(phydev, RTL8367C_TABLE_ACCESS_WRDATA_REG(RTL8367C_ACLRULETBLEN), (0x0007 << 1), (aclRuleSmi.data_bits_ext.rule_info >> 1) & 0x0007);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclRule(struct phy_device *phydev, rtk_uint32 index, rtl8367c_aclrule *pAclRule)
{
    rtl8367c_aclrulesmi aclRuleSmi;
    ...
    /* Read Valid Bit */
    retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_TABLE_ACCESS_RDDATA_REG(RTL8367C_ACLRULETBLEN), 0, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
    aclRuleSmi.valid = regData & 0x1;
    /* Read active_portmsk_ext Bits */
    retVal = rtl8367c_getAsicRegBits(phydev, RTL8367C_TABLE_ACCESS_RDDATA_REG(RTL8367C_ACLRULETBLEN), 0x7<<1, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclNot(struct phy_device *phydev, rtk_uint32 index, rtk_uint32 not)
{
    if(index > RTL8367C_ACLRULEMAX)
        return RT_ERR_OUT_OF_RANGE;

    if(index < 64)
        return rtl8367c_setAsicRegBit(phydev, RTL8367C_ACL_ACTION_CTRL_REG(index), RTL8367C_ACL_OP_NOT_OFFSET(index), not);
    else
        return rtl8367c_setAsicRegBit(phydev, RTL8367C_ACL_ACTION_CTRL2_REG(index), RTL8367C_ACL_OP_NOT_OFFSET(index), not);
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclNot(struct phy_device *phydev, rtk_uint32 index, rtk_uint32* pNot)
{
    if(index > RTL8367C_ACLRULEMAX)
        return RT_ERR_OUT_OF_RANGE;

    if(index < 64)
        return rtl8367c_getAsicRegBit(phydev, RTL8367C_ACL_ACTION_CTRL_REG(index), RTL8367C_ACL_OP_NOT_OFFSET(index), pNot);
    else
        return rtl8367c_getAsicRegBit(phydev, RTL8367C_ACL_ACTION_CTRL2_REG(index), RTL8367C_ACL_OP_NOT_OFFSET(index), pNot);
 ...
 */
ret_t rtl8367c_setAsicAclTemplate(struct phy_device *phydev, rtk_uint32 index, rtl8367c_acltemplate_t* pAclType)
{
    ret_t retVal;
    rtk_uint32 i;
    rtk_uint32 regAddr, regData;
    ...
    for(i = 0; i < (RTL8367C_ACLRULEFIELDNO/2); i++)
    {
        ...
        retVal = rtl8367c_setAsicReg(phydev, regAddr + i, regData);
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclTemplate(struct phy_device *phydev, rtk_uint32 index, rtl8367c_acltemplate_t *pAclType)
{
    ret_t retVal;
    rtk_uint32 i;
    ...
    for(i = 0; i < (RTL8367C_ACLRULEFIELDNO/2); i++)
    {
        retVal = rtl8367c_getAsicReg(phydev, regAddr + i,&regData);
        if(retVal != RT_ERR_OK)
            return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclAct(struct phy_device *phydev, rtk_uint32 index, rtl8367c_acl_act_t* pAclAct)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclAct(struct phy_device *phydev, rtk_uint32 index, rtl8367c_acl_act_t *pAclAct)
{
    rtk_uint16 aclActSmi[RTL8367C_ACL_ACT_TABLE_LEN];
    ret_t retVal;
    rtk_uint32 regAddr, regData;
 ...
 */
ret_t rtl8367c_setAsicAclActCtrl(struct phy_device *phydev, rtk_uint32 index, rtk_uint32 aclActCtrl)
{
    ret_t retVal;
    ...
    if(index >= 64)
        retVal = rtl8367c_setAsicRegBits(phydev, RTL8367C_ACL_ACTION_CTRL2_REG(index), RTL8367C_ACL_OP_ACTION_MASK(index), aclActCtrl);
    else
        retVal = rtl8367c_setAsicRegBits(phydev, RTL8367C_ACL_ACTION_CTRL_REG(index), RTL8367C_ACL_OP_ACTION_MASK(index), aclActCtrl);
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclActCtrl(struct phy_device *phydev, rtk_uint32 index, rtk_uint32 *pAclActCtrl)
{
    ret_t retVal;
    rtk_uint32 regData;
    ...
    if(index >= 64)
        retVal = rtl8367c_getAsicRegBits(phydev, RTL8367C_ACL_ACTION_CTRL2_REG(index), RTL8367C_ACL_OP_ACTION_MASK(index), &regData);
    else
        retVal = rtl8367c_getAsicRegBits(phydev, RTL8367C_ACL_ACTION_CTRL_REG(index), RTL8367C_ACL_OP_ACTION_MASK(index), &regData);
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclPortRange(struct phy_device *phydev, rtk_uint32 index, rtk_uint32 type, rtk_uint32 upperPort, rtk_uint32 lowerPort)
{
    ret_t retVal;
    ...
    retVal = rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_ACL_SDPORT_RANGE_ENTRY0_CTRL2 + index*3, RTL8367C_ACL_SDPORT_RANGE_ENTRY0_CTRL2_MASK, type);
    if(retVal != RT_ERR_OK)
        return retVal;

    retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_ACL_SDPORT_RANGE_ENTRY0_CTRL1 + index*3, upperPort);
    if(retVal != RT_ERR_OK)
        return retVal;

    retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_ACL_SDPORT_RANGE_ENTRY0_CTRL0 + index*3, lowerPort);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclPortRange(struct phy_device *phydev, rtk_uint32 index, rtk_uint32* pType, rtk_uint32* pUpperPort, rtk_uint32* pLowerPort)
{
    ret_t retVal;
    ...
    retVal = rtl8367c_getAsicRegBits(phydev, RTL8367C_REG_ACL_SDPORT_RANGE_ENTRY0_CTRL2 + index*3, RTL8367C_ACL_SDPORT_RANGE_ENTRY0_CTRL2_MASK, pType);
    if(retVal != RT_ERR_OK)
        return retVal;

    retVal = rtl8367c_getAsicReg(phydev, RTL8367C_REG_ACL_SDPORT_RANGE_ENTRY0_CTRL1 + index*3, pUpperPort);
    if(retVal != RT_ERR_OK)
        return retVal;

    retVal = rtl8367c_getAsicReg(phydev, RTL8367C_REG_ACL_SDPORT_RANGE_ENTRY0_CTRL0 + index*3, pLowerPort);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclVidRange(struct phy_device *phydev, rtk_uint32 index, rtk_uint32 type, rtk_uint32 upperVid, rtk_uint32 lowerVid)
{
    ret_t retVal;
    rtk_uint32 regData;
    ...
    retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_ACL_VID_RANGE_ENTRY0_CTRL1 + index*2, regData);
    if(retVal != RT_ERR_OK)
        return retVal;

    retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_ACL_VID_RANGE_ENTRY0_CTRL0 + index*2, lowerVid);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclVidRange(struct phy_device *phydev, rtk_uint32 index, rtk_uint32* pType, rtk_uint32* pUpperVid, rtk_uint32* pLowerVid)
{
    ret_t retVal;
    rtk_uint32 regData;
    ...
    retVal = rtl8367c_getAsicReg(phydev, RTL8367C_REG_ACL_VID_RANGE_ENTRY0_CTRL1 + index*2, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
    ...
    *pUpperVid = regData & RTL8367C_ACL_VID_RANGE_ENTRY0_CTRL1_CHECK0_HIGH_MASK;
    ...
    retVal = rtl8367c_getAsicReg(phydev, RTL8367C_REG_ACL_VID_RANGE_ENTRY0_CTRL0 + index*2, pLowerVid);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclIpRange(struct phy_device *phydev, rtk_uint32 index, rtk_uint32 type, ipaddr_t upperIp, ipaddr_t lowerIp)
{
    ret_t retVal;
    rtk_uint32 regData;
    ipaddr_t ipData;
    ...
    retVal = rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL4 + index*5, RTL8367C_ACL_IP_RANGE_ENTRY0_CTRL4_MASK, type);
    if(retVal != RT_ERR_OK)
        return retVal;
    ...
    retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL2 + index*5, regData);
    if(retVal != RT_ERR_OK)
        return retVal;

    regData = (ipData>>16) & 0xFFFF;
    retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL3 + index*5, regData);
    if(retVal != RT_ERR_OK)
        return retVal;
    ...
    regData = ipData & 0xFFFF;
    retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL0 + index*5, regData);
    if(retVal != RT_ERR_OK)
        return retVal;

    regData = (ipData>>16) & 0xFFFF;
    retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL1 + index*5, regData);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclIpRange(struct phy_device *phydev, rtk_uint32 index, rtk_uint32* pType, ipaddr_t* pUpperIp, ipaddr_t* pLowerIp)
{
    ret_t retVal;
    rtk_uint32 regData;
    ipaddr_t ipData;
    ...
    retVal = rtl8367c_getAsicRegBits(phydev, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL4 + index*5, RTL8367C_ACL_IP_RANGE_ENTRY0_CTRL4_MASK, pType);
    if(retVal != RT_ERR_OK)
        return retVal;

    retVal = rtl8367c_getAsicReg(phydev, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL2 + index*5, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
    ipData = regData;


    retVal = rtl8367c_getAsicReg(phydev, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL3 + index*5, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
    ...
    *pUpperIp = ipData;
    ...
    retVal = rtl8367c_getAsicReg(phydev, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL0 + index*5, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
    ipData = regData;


    retVal = rtl8367c_getAsicReg(phydev, RTL8367C_REG_ACL_IP_RANGE_ENTRY0_CTRL1 + index*5, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      none
 */
ret_t rtl8367c_setAsicAclGpioPolarity(struct phy_device *phydev, rtk_uint32 polarity)
{
    return rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_ACL_GPIO_POLARITY, RTL8367C_ACL_GPIO_POLARITY_OFFSET, polarity);
}
/* Function Name:
 ...
 *      none
 */
ret_t rtl8367c_getAsicAclGpioPolarity(struct phy_device *phydev, rtk_uint32* pPolarity)
{
    return rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_ACL_GPIO_POLARITY, RTL8367C_ACL_GPIO_POLARITY_OFFSET, pPolarity);
}
