 ...
 *      None
 */
ret_t rtl8367c_setAsicInterruptPolarity(struct phy_device *phydev, rtk_uint32 polarity)
{
    return rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_INTR_CTRL, RTL8367C_INTR_CTRL_OFFSET, polarity);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicInterruptPolarity(struct phy_device *phydev, rtk_uint32* pPolarity)
{
    return rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_INTR_CTRL, RTL8367C_INTR_CTRL_OFFSET, pPolarity);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_setAsicInterruptMask(struct phy_device *phydev, rtk_uint32 imr)
{
    return rtl8367c_setAsicReg(phydev, RTL8367C_REG_INTR_IMR, imr);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicInterruptMask(struct phy_device *phydev, rtk_uint32* pImr)
{
    return rtl8367c_getAsicReg(phydev, RTL8367C_REG_INTR_IMR, pImr);
}
/* Function Name:
 *      rtl8367c_setAsicInterruptMask
 * Description:
 ...
 *      [11]: Silent Start
 */
ret_t rtl8367c_setAsicInterruptStatus(struct phy_device *phydev, rtk_uint32 ims)
{
    return rtl8367c_setAsicReg(phydev, RTL8367C_REG_INTR_IMS, ims);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicInterruptStatus(struct phy_device *phydev, rtk_uint32* pIms)
{
    return rtl8367c_getAsicReg(phydev, RTL8367C_REG_INTR_IMS, pIms);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_setAsicInterruptRelatedStatus(struct phy_device *phydev, rtk_uint32 type, rtk_uint32 status)
{
    ...
    return rtl8367c_setAsicReg(phydev, indicatorAddress[type], status);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicInterruptRelatedStatus(struct phy_device *phydev, rtk_uint32 type, rtk_uint32* pStatus)
{
    CONST rtk_uint32 indicatorAddress[INTRST_END] = {RTL8367C_REG_LEARN_OVER_INDICATOR,
                                                    RTL8367C_REG_SPEED_CHANGE_INDICATOR,
                                                    RTL8367C_REG_SPECIAL_CONGEST_INDICATOR,
    ...
    return rtl8367c_getAsicReg(phydev, indicatorAddress[type], pStatus);
}
