 ...
 *      - LEAKY_LLDP.
 */
extern rtk_api_ret_t rtk_leaky_vlan_set(struct phy_device *phydev, rtk_leaky_type_t type, rtk_enable_t enable);
 ...
 *      - LEAKY_LLDP.
 */
extern rtk_api_ret_t rtk_leaky_vlan_get(struct phy_device *phydev, rtk_leaky_type_t type, rtk_enable_t *pEnable);
 ...
 *      - LEAKY_LLDP.
 */
extern rtk_api_ret_t rtk_leaky_portIsolation_set(struct phy_device *phydev, rtk_leaky_type_t type, rtk_enable_t enable);
 ...
 *      - LEAKY_LLDP.
 */
extern rtk_api_ret_t rtk_leaky_portIsolation_get(struct phy_device *phydev, rtk_leaky_type_t type, rtk_enable_t *pEnable);
