 ...
 *      - DOT1X_ACTION_GUESTVLAN
 */
extern rtk_api_ret_t rtk_dot1x_unauthPacketOper_set(struct phy_device *phydev, rtk_port_t port, rtk_dot1x_unauth_action_t unauth_action);
 ...
 *      - DOT1X_ACTION_GUESTVLAN
 */
extern rtk_api_ret_t rtk_dot1x_unauthPacketOper_get(struct phy_device *phydev, rtk_port_t port, rtk_dot1x_unauth_action_t *pUnauth_action);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t rtk_dot1x_eapolFrame2CpuEnable_set(struct phy_device *phydev, rtk_enable_t enable);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t rtk_dot1x_eapolFrame2CpuEnable_get(struct phy_device *phydev, rtk_enable_t *pEnable);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t rtk_dot1x_portBasedEnable_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t enable);
 ...
 */
extern rtk_api_ret_t rtk_dot1x_portBasedEnable_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pEnable);
 ...
 *      - AUTH
 */
extern rtk_api_ret_t rtk_dot1x_portBasedAuthStatus_set(struct phy_device *phydev, rtk_port_t port, rtk_dot1x_auth_status_t port_auth);
 ...
 */
extern rtk_api_ret_t rtk_dot1x_portBasedAuthStatus_get(struct phy_device *phydev, rtk_port_t port, rtk_dot1x_auth_status_t *pPort_auth);
 ...
 *      - IN
 */
extern rtk_api_ret_t rtk_dot1x_portBasedDirection_set(struct phy_device *phydev, rtk_port_t port, rtk_dot1x_direction_t port_direction);
 ...
 */
extern rtk_api_ret_t rtk_dot1x_portBasedDirection_get(struct phy_device *phydev, rtk_port_t port, rtk_dot1x_direction_t *pPort_direction);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t rtk_dot1x_macBasedEnable_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t enable);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t rtk_dot1x_macBasedEnable_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pEnable);
 ...
 */
extern rtk_api_ret_t rtk_dot1x_macBasedAuthMac_add(struct phy_device *phydev, rtk_port_t port, rtk_mac_t *pAuth_mac, rtk_fid_t fid);
 ...
 */
extern rtk_api_ret_t rtk_dot1x_macBasedAuthMac_del(struct phy_device *phydev, rtk_port_t port, rtk_mac_t *pAuth_mac, rtk_fid_t fid);
 ...
 *      - IN
 */
extern rtk_api_ret_t rtk_dot1x_macBasedDirection_set(struct phy_device *phydev, rtk_dot1x_direction_t mac_direction);
 ...
 */
extern rtk_api_ret_t rtk_dot1x_macBasedDirection_get(struct phy_device *phydev, rtk_dot1x_direction_t *pMac_direction);
 ...
 */
extern rtk_api_ret_t rtk_dot1x_guestVlan_set(struct phy_device *phydev, rtk_vlan_t vid);
 ...
 */
extern rtk_api_ret_t rtk_dot1x_guestVlan_get(struct phy_device *phydev, rtk_vlan_t *pVid);
 ...
 *      - DISABLED
 */
extern rtk_api_ret_t rtk_dot1x_guestVlan2Auth_set(struct phy_device *phydev, rtk_enable_t enable);
 ...
 */
extern rtk_api_ret_t rtk_dot1x_guestVlan2Auth_get(struct phy_device *phydev, rtk_enable_t *pEnable);
