 ...
 *      None
 */
extern rtk_api_ret_t rtk_rldp_config_set(struct phy_device *phydev, rtk_rldp_config_t *pConfig);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_rldp_config_get(struct phy_device *phydev, rtk_rldp_config_t *pConfig);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_rldp_portConfig_set(struct phy_device *phydev, rtk_port_t port, rtk_rldp_portConfig_t *pPortConfig);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_rldp_portConfig_get(struct phy_device *phydev, rtk_port_t port, rtk_rldp_portConfig_t *pPortConfig);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_rldp_status_get(struct phy_device *phydev, rtk_rldp_status_t *pStatus);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_rldp_portStatus_get(struct phy_device *phydev, rtk_port_t port, rtk_rldp_portStatus_t *pPortStatus);
 ...
 */
extern rtk_api_ret_t rtk_rldp_portStatus_set(struct phy_device *phydev, rtk_port_t port, rtk_rldp_portStatus_t *pPortStatus);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_rldp_portLoopPair_get(struct phy_device *phydev, rtk_port_t port, rtk_portmask_t *pPortmask);
