 ...
 */
extern rtk_api_ret_t rtk_eee_init(struct phy_device *phydev);
 ...
 *      - ENABLE
 */
extern rtk_api_ret_t rtk_eee_portEnable_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t enable);
 ...
 *      - ENABLE
 */
extern rtk_api_ret_t rtk_eee_portEnable_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pEnable);
