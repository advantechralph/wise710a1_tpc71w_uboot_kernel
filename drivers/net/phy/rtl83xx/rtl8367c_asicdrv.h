...
extern "C" {
#endif
extern ret_t rtl8367c_setAsicRegBit(struct phy_device *phydev, rtk_uint32 reg, rtk_uint32 bit, rtk_uint32 value);
extern ret_t rtl8367c_getAsicRegBit(struct phy_device *phydev, rtk_uint32 reg, rtk_uint32 bit, rtk_uint32 *pValue);

extern ret_t rtl8367c_setAsicRegBits(struct phy_device *phydev, rtk_uint32 reg, rtk_uint32 bits, rtk_uint32 value);
extern ret_t rtl8367c_getAsicRegBits(struct phy_device *phydev, rtk_uint32 reg, rtk_uint32 bits, rtk_uint32 *pValue);

extern ret_t rtl8367c_setAsicReg(struct phy_device *phydev, rtk_uint32 reg, rtk_uint32 value);
extern ret_t rtl8367c_getAsicReg(struct phy_device *phydev, rtk_uint32 reg, rtk_uint32 *pValue);
