 ...
 */
#define RTK_MAX_NUM_OF_LEARN_LIMIT                  (rtk_switch_maxLutAddrNumber_get(phydev))
 ...
 */
extern rtk_api_ret_t rtk_l2_init(struct phy_device *phydev);
 ...
 */
extern rtk_api_ret_t rtk_l2_addr_add(struct phy_device *phydev, rtk_mac_t *pMac, rtk_l2_ucastAddr_t *pL2_data);
 ...
 */
extern rtk_api_ret_t rtk_l2_addr_get(struct phy_device *phydev, rtk_mac_t *pMac, rtk_l2_ucastAddr_t *pL2_data);
 ...
 */
extern rtk_api_ret_t rtk_l2_addr_next_get(struct phy_device *phydev, rtk_l2_read_method_t read_method, rtk_port_t port, rtk_uint32 *pAddress, rtk_l2_ucastAddr_t *pL2_data);
 ...
 */
extern rtk_api_ret_t rtk_l2_addr_del(struct phy_device *phydev, rtk_mac_t *pMac, rtk_l2_ucastAddr_t *pL2_data);
 ...
 */
extern rtk_api_ret_t rtk_l2_mcastAddr_add(struct phy_device *phydev, rtk_l2_mcastAddr_t *pMcastAddr);
 ...
 *      the mac is learned. Otherwise, it will return a RT_ERR_L2_ENTRY_NOTFOUND error.
 */
extern rtk_api_ret_t rtk_l2_mcastAddr_get(struct phy_device *phydev, rtk_l2_mcastAddr_t *pMcastAddr);
 ...
 */
extern rtk_api_ret_t rtk_l2_mcastAddr_next_get(struct phy_device *phydev, rtk_uint32 *pAddress, rtk_l2_mcastAddr_t *pMcastAddr);
 ...
 *      If the mac has existed in the LUT, it will be deleted. Otherwise, it will return RT_ERR_L2_ENTRY_NOTFOUND.
 */
extern rtk_api_ret_t rtk_l2_mcastAddr_del(struct phy_device *phydev, rtk_l2_mcastAddr_t *pMcastAddr);
 ...
 */
extern rtk_api_ret_t rtk_l2_ipMcastAddr_add(struct phy_device *phydev, rtk_l2_ipMcastAddr_t *pIpMcastAddr);
 ...
 */
extern rtk_api_ret_t rtk_l2_ipMcastAddr_get(struct phy_device *phydev, rtk_l2_ipMcastAddr_t *pIpMcastAddr);
 ...
 */
extern rtk_api_ret_t rtk_l2_ipMcastAddr_next_get(struct phy_device *phydev, rtk_uint32 *pAddress, rtk_l2_ipMcastAddr_t *pIpMcastAddr);
 ...
 */
extern rtk_api_ret_t rtk_l2_ipMcastAddr_del(struct phy_device *phydev, rtk_l2_ipMcastAddr_t *pIpMcastAddr);
 ...
 *
 */
extern rtk_api_ret_t rtk_l2_ipVidMcastAddr_add(struct phy_device *phydev, rtk_l2_ipVidMcastAddr_t *pIpVidMcastAddr);
 ...
 *
 */
extern rtk_api_ret_t rtk_l2_ipVidMcastAddr_get(struct phy_device *phydev, rtk_l2_ipVidMcastAddr_t *pIpVidMcastAddr);
 ...
 *      as pAddress to call this API again for dumping all IP multicast entries is LUT.
 */
extern rtk_api_ret_t rtk_l2_ipVidMcastAddr_next_get(struct phy_device *phydev, rtk_uint32 *pAddress, rtk_l2_ipVidMcastAddr_t *pIpVidMcastAddr);
 ...
 *
 */
extern rtk_api_ret_t rtk_l2_ipVidMcastAddr_del(struct phy_device *phydev, rtk_l2_ipVidMcastAddr_t *pIpVidMcastAddr);
 ...
 */
extern rtk_api_ret_t rtk_l2_ucastAddr_flush(struct phy_device *phydev, rtk_l2_flushCfg_t *pConfig);
 ...
 *
 */
extern rtk_api_ret_t rtk_l2_table_clear(struct phy_device *phydev);
 ...
 *
 */
extern rtk_api_ret_t rtk_l2_table_clearStatus_get(struct phy_device *phydev, rtk_l2_clearStatus_t *pStatus);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t rtk_l2_flushLinkDownPortAddrEnable_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t enable);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t rtk_l2_flushLinkDownPortAddrEnable_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pEnable);
 ...
 */
extern rtk_api_ret_t rtk_l2_agingEnable_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t enable);
 ...
 */
extern rtk_api_ret_t rtk_l2_agingEnable_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pEnable);
 ...
 *      to 8k.
 */
extern rtk_api_ret_t rtk_l2_limitLearningCnt_set(struct phy_device *phydev, rtk_port_t port, rtk_mac_cnt_t mac_cnt);
 ...
 */
extern rtk_api_ret_t rtk_l2_limitLearningCnt_get(struct phy_device *phydev, rtk_port_t port, rtk_mac_cnt_t *pMac_cnt);
 ...
 *      to 2112.
 */
extern rtk_api_ret_t rtk_l2_limitSystemLearningCnt_set(struct phy_device *phydev, rtk_mac_cnt_t mac_cnt);
 ...
 */
extern rtk_api_ret_t rtk_l2_limitSystemLearningCnt_get(struct phy_device *phydev, rtk_mac_cnt_t *pMac_cnt);
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
extern rtk_api_ret_t rtk_l2_limitLearningCntAction_set(struct phy_device *phydev, rtk_port_t port, rtk_l2_limitLearnCntAction_t action);
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
extern rtk_api_ret_t rtk_l2_limitLearningCntAction_get(struct phy_device *phydev, rtk_port_t port, rtk_l2_limitLearnCntAction_t *pAction);
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
extern rtk_api_ret_t rtk_l2_limitSystemLearningCntAction_set(struct phy_device *phydev, rtk_l2_limitLearnCntAction_t action);
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
extern rtk_api_ret_t rtk_l2_limitSystemLearningCntAction_get(struct phy_device *phydev, rtk_l2_limitLearnCntAction_t *pAction);
 ...
 *
 */
extern rtk_api_ret_t rtk_l2_limitSystemLearningCntPortMask_set(struct phy_device *phydev, rtk_portmask_t *pPortmask);
 ...
 *
 */
extern rtk_api_ret_t rtk_l2_limitSystemLearningCntPortMask_get(struct phy_device *phydev, rtk_portmask_t *pPortmask);
 ...
 */
extern rtk_api_ret_t rtk_l2_learningCnt_get(struct phy_device *phydev, rtk_port_t port, rtk_mac_cnt_t *pMac_cnt);
 ...
 *      - FLOOD_BC
 */
extern rtk_api_ret_t rtk_l2_floodPortMask_set(struct phy_device *phydev, rtk_l2_flood_type_t floood_type, rtk_portmask_t *pFlood_portmask);
 ...
 *      - FLOOD_BC
 */
extern rtk_api_ret_t rtk_l2_floodPortMask_get(struct phy_device *phydev, rtk_l2_flood_type_t floood_type, rtk_portmask_t *pFlood_portmask);
 ...
 */
extern rtk_api_ret_t rtk_l2_localPktPermit_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t permit);
 ...
 */
extern rtk_api_ret_t rtk_l2_localPktPermit_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pPermit);
 ...
 */
extern rtk_api_ret_t rtk_l2_aging_set(struct phy_device *phydev, rtk_l2_age_time_t aging_time);
 ...
 */
extern rtk_api_ret_t rtk_l2_aging_get(struct phy_device *phydev, rtk_l2_age_time_t *pAging_time);
 ...
 */
extern rtk_api_ret_t rtk_l2_ipMcastAddrLookup_set(struct phy_device *phydev, rtk_l2_ipmc_lookup_type_t type);
 ...
 *      None.
 */
extern rtk_api_ret_t rtk_l2_ipMcastAddrLookup_get(struct phy_device *phydev, rtk_l2_ipmc_lookup_type_t *pType);
 ...
 *
 */
extern rtk_api_ret_t rtk_l2_ipMcastForwardRouterPort_set(struct phy_device *phydev, rtk_enable_t enabled);
 ...
 *
 */
extern rtk_api_ret_t rtk_l2_ipMcastForwardRouterPort_get(struct phy_device *phydev, rtk_enable_t *pEnabled);
 ...
 */
extern rtk_api_ret_t rtk_l2_ipMcastGroupEntry_add(struct phy_device *phydev, ipaddr_t ip_addr, rtk_uint32 vid, rtk_portmask_t *pPortmask);
 ...
 *      Delete an entry from IP Multicast group table.
 */
extern rtk_api_ret_t rtk_l2_ipMcastGroupEntry_del(struct phy_device *phydev, ipaddr_t ip_addr, rtk_uint32 vid);
 ...
 *      Delete an entry from IP Multicast group table.
 */
extern rtk_api_ret_t rtk_l2_ipMcastGroupEntry_get(struct phy_device *phydev, ipaddr_t ip_addr, rtk_uint32 vid, rtk_portmask_t *pPortmask);
 ...
 */
extern rtk_api_ret_t rtk_l2_entry_get(struct phy_device *phydev, rtk_l2_addr_table_t *pL2_entry);
