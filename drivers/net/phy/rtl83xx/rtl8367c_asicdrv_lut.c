 ...
 *      None
 */
ret_t rtl8367c_setAsicLutIpMulticastLookup(struct phy_device *phydev, rtk_uint32 enabled)
{
    return rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_LUT_CFG, RTL8367C_LUT_IPMC_HASH_OFFSET, enabled);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutIpMulticastLookup(struct phy_device *phydev, rtk_uint32* pEnabled)
{
    return rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_LUT_CFG, RTL8367C_LUT_IPMC_HASH_OFFSET, pEnabled);
}
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutIpMulticastVidLookup(struct phy_device *phydev, rtk_uint32 enabled)
{
    return rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_LUT_CFG2, RTL8367C_LUT_IPMC_VID_HASH_OFFSET, enabled);
}
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutIpMulticastVidLookup(struct phy_device *phydev, rtk_uint32* pEnabled)
{
    return rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_LUT_CFG2, RTL8367C_LUT_IPMC_VID_HASH_OFFSET, pEnabled);
}
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutIpLookupMethod(struct phy_device *phydev, rtk_uint32 type)
{
    return rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_LUT_CFG, RTL8367C_LUT_IPMC_LOOKUP_OP_OFFSET, type);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutIpLookupMethod(struct phy_device *phydev, rtk_uint32* pType)
{
    return rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_LUT_CFG, RTL8367C_LUT_IPMC_LOOKUP_OP_OFFSET, pType);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutAgeTimerSpeed(struct phy_device *phydev, rtk_uint32 timer, rtk_uint32 speed)
{
    ...
    return rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_LUT_CFG, RTL8367C_AGE_TIMER_MASK | RTL8367C_AGE_SPEED_MASK, (timer << RTL8367C_AGE_TIMER_OFFSET) | (speed << RTL8367C_AGE_SPEED_OFFSET));
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutAgeTimerSpeed(struct phy_device *phydev, rtk_uint32* pTimer, rtk_uint32* pSpeed)
{
    rtk_uint32 regData;
    ret_t retVal;

    retVal = rtl8367c_getAsicReg(phydev, RTL8367C_REG_LUT_CFG, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutCamTbUsage(struct phy_device *phydev, rtk_uint32 enabled)
{
    ret_t retVal;

    retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_LUT_CFG, RTL8367C_BCAM_DISABLE_OFFSET, enabled ? 0 : 1);
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutCamTbUsage(struct phy_device *phydev, rtk_uint32* pEnabled)
{
    ret_t       retVal;
    rtk_uint32  regData;

    if ((retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_LUT_CFG, RTL8367C_BCAM_DISABLE_OFFSET, &regData)) != RT_ERR_OK)
        return retVal;
...
ret_t rtl8367c_setAsicLutLearnLimitNo(struct phy_device *phydev, rtk_uint32 port, rtk_uint32 number)
{
    ...
    if(port < 8)
     return rtl8367c_setAsicReg(phydev, RTL8367C_LUT_PORT_LEARN_LIMITNO_REG(port), number);
    else
        return rtl8367c_setAsicReg(phydev, RTL8367C_REG_LUT_PORT8_LEARN_LIMITNO+port-8, number);
...
ret_t rtl8367c_getAsicLutLearnLimitNo(struct phy_device *phydev, rtk_uint32 port, rtk_uint32* pNumber)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;

    if(port < 8)
     return rtl8367c_getAsicReg(phydev, RTL8367C_LUT_PORT_LEARN_LIMITNO_REG(port), pNumber);
    else
        return rtl8367c_getAsicReg(phydev, RTL8367C_REG_LUT_PORT8_LEARN_LIMITNO+port-8, pNumber);
}
...
ret_t rtl8367c_setAsicSystemLutLearnLimitNo(struct phy_device *phydev, rtk_uint32 number)
{
    if(number > RTL8367C_LUT_LEARNLIMITMAX)
        return RT_ERR_LIMITED_L2ENTRY_NUM;

    return rtl8367c_setAsicReg(phydev, RTL8367C_REG_LUT_SYS_LEARN_LIMITNO, number);
}
 ...
 *      None
 */
ret_t rtl8367c_getAsicSystemLutLearnLimitNo(struct phy_device *phydev, rtk_uint32 *pNumber)
{
    if(NULL == pNumber)
        return RT_ERR_NULL_POINTER;

    return rtl8367c_getAsicReg(phydev, RTL8367C_REG_LUT_SYS_LEARN_LIMITNO, pNumber);
}
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutLearnOverAct(struct phy_device *phydev, rtk_uint32 action)
{
    if(action >= LRNOVERACT_END)
        return RT_ERR_NOT_ALLOWED;

    return rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_PORT_SECURITY_CTRL, RTL8367C_LUT_LEARN_OVER_ACT_MASK, action);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutLearnOverAct(struct phy_device *phydev, rtk_uint32* pAction)
{
    return rtl8367c_getAsicRegBits(phydev, RTL8367C_REG_PORT_SECURITY_CTRL, RTL8367C_LUT_LEARN_OVER_ACT_MASK, pAction);
}
 ...
 *      None
 */
ret_t rtl8367c_setAsicSystemLutLearnOverAct(struct phy_device *phydev, rtk_uint32 action)
{
    if(action >= LRNOVERACT_END)
        return RT_ERR_NOT_ALLOWED;

    return rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_LUT_LRN_SYS_LMT_CTRL, RTL8367C_LUT_SYSTEM_LEARN_OVER_ACT_MASK, action);
}
 ...
 *      None
 */
ret_t rtl8367c_getAsicSystemLutLearnOverAct(struct phy_device *phydev, rtk_uint32 *pAction)
{
    if(NULL == pAction)
        return RT_ERR_NULL_POINTER;

    return rtl8367c_getAsicRegBits(phydev, RTL8367C_REG_LUT_LRN_SYS_LMT_CTRL, RTL8367C_LUT_SYSTEM_LEARN_OVER_ACT_MASK, pAction);
}
...
ret_t rtl8367c_setAsicSystemLutLearnPortMask(struct phy_device *phydev, rtk_uint32 portmask)
{
    ret_t retVal;
    ...
    retVal = rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_LUT_LRN_SYS_LMT_CTRL, RTL8367C_LUT_SYSTEM_LEARN_PMASK_MASK, portmask & 0xff);
    if(retVal != RT_ERR_OK)
        return retVal;
    retVal = rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_LUT_LRN_SYS_LMT_CTRL, RTL8367C_LUT_SYSTEM_LEARN_PMASK1_MASK, (portmask>>8) & 0x7);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 */
 /*�޸�: RTL8367C_LUT_SYSTEM_LEARN_PMASK_MASK*/
ret_t rtl8367c_getAsicSystemLutLearnPortMask(struct phy_device *phydev, rtk_uint32 *pPortmask)
{
    rtk_uint32 tmpmask;
    ret_t retVal;
    ...
    retVal = rtl8367c_getAsicRegBits(phydev, RTL8367C_REG_LUT_LRN_SYS_LMT_CTRL, RTL8367C_LUT_SYSTEM_LEARN_PMASK_MASK, &tmpmask);
    if(retVal != RT_ERR_OK)
        return retVal;
    *pPortmask = tmpmask & 0xff;
    retVal = rtl8367c_getAsicRegBits(phydev, RTL8367C_REG_LUT_LRN_SYS_LMT_CTRL, RTL8367C_LUT_SYSTEM_LEARN_PMASK1_MASK, &tmpmask);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicL2LookupTb(struct phy_device *phydev, rtl8367c_luttb *pL2Table)
{
    ret_t retVal;
    rtk_uint32 regData;
    ...
    while(busyCounter)
    {
        retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_TABLE_ACCESS_STATUS_REG, RTL8367C_TABLE_LUT_ADDR_BUSY_FLAG_OFFSET,&regData);
        if(retVal != RT_ERR_OK)
            return retVal;
    ...
    {
        retVal = rtl8367c_setAsicReg(phydev, RTL8367C_TABLE_ACCESS_WRDATA_BASE + i, regData);
        if(retVal != RT_ERR_OK)
            return retVal;
    ...
    /* Write Command */
    retVal = rtl8367c_setAsicReg(phydev, RTL8367C_TABLE_ACCESS_CTRL_REG, tblCmd);
    if(retVal != RT_ERR_OK)
        return retVal;
    ...
    /*Read access status*/
    retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_TABLE_ACCESS_STATUS_REG, RTL8367C_HIT_STATUS_OFFSET, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
    ...
    /*Read access address*/
    /*
    retVal = rtl8367c_getAsicRegBits(phydev, RTL8367C_TABLE_ACCESS_STATUS_REG, RTL8367C_TABLE_LUT_ADDR_TYPE_MASK | RTL8367C_TABLE_LUT_ADDR_ADDRESS_MASK,&regData);
    if(retVal != RT_ERR_OK)
        return retVal;

    pL2Table->address = regData;*/

    retVal = rtl8367c_getAsicReg(phydev, RTL8367C_TABLE_ACCESS_STATUS_REG, &regData);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicL2LookupTb(struct phy_device *phydev, rtk_uint32 method, rtl8367c_luttb *pL2Table)
{
    ret_t retVal;
    rtk_uint32 regData;
    rtk_uint16* accessPtr;
    ...
    switch(method)
    {
        ...
        case LUTREADMETHOD_NEXT_L2L3MC:
            retVal = rtl8367c_setAsicReg(phydev, RTL8367C_TABLE_ACCESS_ADDR_REG, pL2Table->address);
            if(retVal != RT_ERR_OK)
                return retVal;
            break;
    ...
    for(i = 0; i < RTL8367C_LUT_ENTRY_SIZE; i++)
    {
        retVal = rtl8367c_getAsicReg(phydev, RTL8367C_TABLE_ACCESS_RDDATA_BASE + i, &regData);
        if(retVal != RT_ERR_OK)
            return retVal;
...
ret_t rtl8367c_getAsicLutLearnNo(struct phy_device *phydev, rtk_uint32 port, rtk_uint32* pNumber)
{
    ret_t retVal;
    ...
    if(port < 10)
    {
     retVal = rtl8367c_getAsicReg(phydev, RTL8367C_REG_L2_LRN_CNT_REG(port), pNumber);
        if (retVal != RT_ERR_OK)
         return retVal;
    }
    else
    {
        retVal = rtl8367c_getAsicReg(phydev, RTL8367C_REG_L2_LRN_CNT_CTRL10, pNumber);
        if (retVal != RT_ERR_OK)
         return retVal;
    }
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutFlushAll(struct phy_device *phydev)
{
    return rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_L2_FLUSH_CTRL3, RTL8367C_L2_FLUSH_CTRL3_OFFSET, 1);
}
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutFlushAllStatus(struct phy_device *phydev, rtk_uint32 *pBusyStatus)
{
    if(NULL == pBusyStatus)
        return RT_ERR_NULL_POINTER;

    return rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_L2_FLUSH_CTRL3, RTL8367C_L2_FLUSH_CTRL3_OFFSET, pBusyStatus);
}
...
ret_t rtl8367c_setAsicLutForceFlush(struct phy_device *phydev, rtk_uint32 portmask)
{
    ret_t retVal;
    ...
    retVal = rtl8367c_setAsicRegBits(phydev, RTL8367C_FORCE_FLUSH_REG, RTL8367C_FORCE_FLUSH_PORTMASK_MASK, portmask & 0xff);
    if(retVal != RT_ERR_OK)
        return retVal;

    retVal = rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_FORCE_FLUSH1, RTL8367C_PORTMASK1_MASK, (portmask >> 8) & 0x7);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 */
 /*port8~port10������������һ��register, wait for updating of base.h, reg.h*/
ret_t rtl8367c_getAsicLutForceFlushStatus(struct phy_device *phydev, rtk_uint32 *pPortmask)
{
    rtk_uint32 tmpMask;
    ret_t retVal;

    retVal = rtl8367c_getAsicRegBits(phydev, RTL8367C_FORCE_FLUSH_REG, RTL8367C_BUSY_STATUS_MASK,&tmpMask);
    if(retVal != RT_ERR_OK)
        return retVal;
    *pPortmask = tmpMask & 0xff;

    retVal = rtl8367c_getAsicRegBits(phydev, RTL8367C_REG_FORCE_FLUSH1, RTL8367C_BUSY_STATUS1_MASK,&tmpMask);
    if(retVal != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutFlushMode(struct phy_device *phydev, rtk_uint32 mode)
{
    if( mode >= FLUSHMDOE_END )
        return RT_ERR_NOT_ALLOWED;

    return rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_L2_FLUSH_CTRL2, RTL8367C_LUT_FLUSH_MODE_MASK, mode);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutFlushMode(struct phy_device *phydev, rtk_uint32* pMode)
{
    return rtl8367c_getAsicRegBits(phydev, RTL8367C_REG_L2_FLUSH_CTRL2, RTL8367C_LUT_FLUSH_MODE_MASK, pMode);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutFlushType(struct phy_device *phydev, rtk_uint32 type)
{
    return rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_L2_FLUSH_CTRL2, RTL8367C_LUT_FLUSH_TYPE_OFFSET,type);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutFlushType(struct phy_device *phydev, rtk_uint32* pType)
{
    return rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_L2_FLUSH_CTRL2, RTL8367C_LUT_FLUSH_TYPE_OFFSET,pType);
}
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutFlushVid(struct phy_device *phydev, rtk_uint32 vid)
{
    if( vid > RTL8367C_VIDMAX )
        return RT_ERR_VLAN_VID;

    return rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_L2_FLUSH_CTRL1, RTL8367C_LUT_FLUSH_VID_MASK, vid);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutFlushVid(struct phy_device *phydev, rtk_uint32* pVid)
{
    return rtl8367c_getAsicRegBits(phydev, RTL8367C_REG_L2_FLUSH_CTRL1, RTL8367C_LUT_FLUSH_VID_MASK, pVid);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutFlushFid(struct phy_device *phydev, rtk_uint32 fid)
{
    if( fid > RTL8367C_FIDMAX )
        return RT_ERR_L2_FID;

    return rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_L2_FLUSH_CTRL1, RTL8367C_LUT_FLUSH_FID_MASK, fid);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutFlushFid(struct phy_device *phydev, rtk_uint32* pFid)
{
    return rtl8367c_getAsicRegBits(phydev, RTL8367C_REG_L2_FLUSH_CTRL1, RTL8367C_LUT_FLUSH_FID_MASK, pFid);
}
/* Function Name:
 ...
 */
 /*�޸�RTL8367C_PORTIDMAX*/
ret_t rtl8367c_setAsicLutDisableAging(struct phy_device *phydev, rtk_uint32 port, rtk_uint32 disabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;

    return rtl8367c_setAsicRegBit(phydev, RTL8367C_LUT_AGEOUT_CTRL_REG, port, disabled);
}
/* Function Name:
 ...
 */
 /*�޸�RTL8367C_PORTIDMAX*/
ret_t rtl8367c_getAsicLutDisableAging(struct phy_device *phydev, rtk_uint32 port, rtk_uint32 *pDisabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;

    return rtl8367c_getAsicRegBit(phydev, RTL8367C_LUT_AGEOUT_CTRL_REG, port, pDisabled);
}
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutIPMCGroup(struct phy_device *phydev, rtk_uint32 index, ipaddr_t group_addr, rtk_uint32 vid, rtk_uint32 pmask, rtk_uint32 valid)
{
    ...
    bitoffset = index % 16;
    if( (retVal = rtl8367c_setAsicRegBit(phydev, regAddr, bitoffset, valid)) != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutIPMCGroup(struct phy_device *phydev, rtk_uint32 index, ipaddr_t *pGroup_addr, rtk_uint32 *pVid, rtk_uint32 *pPmask, rtk_uint32 *pValid)
{
    rtk_uint32      regAddr, regData, bitoffset;
    ipaddr_t    ipData;
    ret_t       retVal;
    ...
    *pPmask = regData;
    ...
    regAddr = RTL8367C_REG_IPMC_GROUP_VALID_15_0 + (index / 16);
    bitoffset = index % 16;
    if( (retVal = rtl8367c_getAsicRegBit(phydev, regAddr, bitoffset, &regData)) != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutLinkDownForceAging(struct phy_device *phydev, rtk_uint32 enable)
{
    if(enable > 1)
        return RT_ERR_ENABLE;

    return rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_LUT_CFG, RTL8367C_LINKDOWN_AGEOUT_OFFSET, enable ? 0 : 1);
}
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutLinkDownForceAging(struct phy_device *phydev, rtk_uint32 *pEnable)
{
    rtk_uint32  value;
    ret_t   retVal;

    if ((retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_LUT_CFG, RTL8367C_LINKDOWN_AGEOUT_OFFSET, &value)) != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutIpmcFwdRouterPort(struct phy_device *phydev, rtk_uint32 enable)
{
    if(enable > 1)
        return RT_ERR_ENABLE;

    return rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_LUT_CFG2, RTL8367C_LUT_IPMC_FWD_RPORT_OFFSET, enable);
}
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutIpmcFwdRouterPort(struct phy_device *phydev, rtk_uint32 *pEnable)
{
    if(NULL == pEnable)
        return RT_ERR_NULL_POINTER;

    return rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_LUT_CFG2, RTL8367C_LUT_IPMC_FWD_RPORT_OFFSET, pEnable);
}
