...
*/
ret_t rtl8367c_setAsicEee100M(struct phy_device *phydev, rtk_uint32 port, rtk_uint32 enable)
{
    ...
    if((retVal = rtl8367c_getAsicPHYOCPReg(phydev, port, EEE_OCP_PHY_ADDR, &regData)) != RT_ERR_OK)
        return retVal;
    ...
    if((retVal = rtl8367c_setAsicPHYOCPReg(phydev, port, EEE_OCP_PHY_ADDR, regData)) != RT_ERR_OK)
        return retVal;
...
*/
ret_t rtl8367c_getAsicEee100M(struct phy_device *phydev, rtk_uint32 port, rtk_uint32 *enable)
{
    rtk_api_ret_t   retVal;
    rtk_uint32      regData;
...
*/
ret_t rtl8367c_setAsicEeeGiga(struct phy_device *phydev, rtk_uint32 port, rtk_uint32 enable)
{
    rtk_api_ret_t   retVal;
    rtk_uint32      regData;
...
@comm
    This API get the 100M EEE function.
*/
ret_t rtl8367c_getAsicEeeGiga(struct phy_device *phydev, rtk_uint32 port, rtk_uint32 *enable)
{
    rtk_api_ret_t   retVal;
    rtk_uint32      regData;
