 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsCounterReset(struct phy_device *phydev, rtk_uint32 greset, rtk_uint32 qmreset, rtk_uint32 portmask)
{
    ret_t retVal;
    rtk_uint32 regData;
    rtk_uint32 regBits;
    ...
    retVal = rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_MIB_CTRL0, regBits, (regData >> RTL8367C_PORT0_RESET_OFFSET));
 ...
 */
ret_t rtl8367c_getAsicMIBsCounter(struct phy_device *phydev, rtk_uint32 port, RTL8367C_MIBCOUNTER mibIdx, rtk_uint64* pCounter)
{
    ret_t retVal;
    rtk_uint32 regAddr;
    rtk_uint32 regData;
    ...
    retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_MIB_ADDRESS, (mibAddr >> 2));
    if(retVal != RT_ERR_OK)
        return retVal;
    ...
    while(i > 0)
    {
        ...
        retVal = rtl8367c_getAsicReg(phydev, RTL8367C_MIB_CTRL_REG,&regData);
        if(retVal != RT_ERR_OK)
            return retVal;
 ...
 */
ret_t rtl8367c_getAsicMIBsLogCounter(struct phy_device *phydev, rtk_uint32 index, rtk_uint32 *pCounter)
{
    ret_t retVal;
    rtk_uint32 regAddr;
    rtk_uint32 regData;
 ...
 */
ret_t rtl8367c_getAsicMIBsControl(struct phy_device *phydev, rtk_uint32* pMask)
{
    ret_t retVal;
    rtk_uint32 regData;
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsResetValue(struct phy_device *phydev, rtk_uint32 value)
{
    return rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_MIB_CTRL0, RTL8367C_RESET_VALUE_OFFSET, value);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsResetValue(struct phy_device *phydev, rtk_uint32* value)
{
    return rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_MIB_CTRL0, RTL8367C_RESET_VALUE_OFFSET, value);
}
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsUsageMode(struct phy_device *phydev, rtk_uint32 mode)
{
    return rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_MIB_CTRL4, RTL8367C_MIB_USAGE_MODE_OFFSET, mode);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsUsageMode(struct phy_device *phydev, rtk_uint32* pMode)
{
    return rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_MIB_CTRL4, RTL8367C_MIB_USAGE_MODE_OFFSET, pMode);
}
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsTimer(struct phy_device *phydev, rtk_uint32 timer)
{
    return rtl8367c_setAsicRegBits(phydev, RTL8367C_REG_MIB_CTRL4, RTL8367C_MIB_TIMER_MASK, timer);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsTimer(struct phy_device *phydev, rtk_uint32* pTimer)
{
    return rtl8367c_getAsicRegBits(phydev, RTL8367C_REG_MIB_CTRL4, RTL8367C_MIB_TIMER_MASK, pTimer);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsLoggingMode(struct phy_device *phydev, rtk_uint32 index, rtk_uint32 mode)
{
    if(index > RTL8367C_MIB_MAX_LOG_MODE_IDX)
        return RT_ERR_OUT_OF_RANGE;

    return rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_MIB_CTRL3, index,mode);
}
/* Function Name:
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsLoggingMode(struct phy_device *phydev, rtk_uint32 index, rtk_uint32* pMode)
{
    if(index > RTL8367C_MIB_MAX_LOG_MODE_IDX)
        return RT_ERR_OUT_OF_RANGE;

    return rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_MIB_CTRL3, index,pMode);
}
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsLoggingType(struct phy_device *phydev, rtk_uint32 index, rtk_uint32 type)
{
    if(index > RTL8367C_MIB_MAX_LOG_MODE_IDX)
        return RT_ERR_OUT_OF_RANGE;

    return rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_MIB_CTRL5, index,type);
}
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsLoggingType(struct phy_device *phydev, rtk_uint32 index, rtk_uint32* pType)
{
    if(index > RTL8367C_MIB_MAX_LOG_MODE_IDX)
        return RT_ERR_OUT_OF_RANGE;

    return rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_MIB_CTRL5, index,pType);
}
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsResetLoggingCounter(struct phy_device *phydev, rtk_uint32 index)
{
    ret_t retVal;
    ...
    if(index < 16)
        retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_MIB_CTRL1, 1<<index);
    else
        retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_MIB_CTRL2, 1<<(index-16));
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsLength(struct phy_device *phydev, rtk_uint32 txLengthMode, rtk_uint32 rxLengthMode)
{
    ret_t retVal;

    if( (retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_MIB_RMON_LEN_CTRL, RTL8367C_TX_LENGTH_CTRL_OFFSET, txLengthMode)) != RT_ERR_OK)
        return retVal;

    if( (retVal = rtl8367c_setAsicRegBit(phydev, RTL8367C_REG_MIB_RMON_LEN_CTRL, RTL8367C_RX_LENGTH_CTRL_OFFSET, rxLengthMode)) != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsLength(struct phy_device *phydev, rtk_uint32 *pTxLengthMode, rtk_uint32 *pRxLengthMode)
{
    ret_t retVal;

    if( (retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_MIB_RMON_LEN_CTRL, RTL8367C_TX_LENGTH_CTRL_OFFSET, pTxLengthMode)) != RT_ERR_OK)
        return retVal;

    if( (retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_MIB_RMON_LEN_CTRL, RTL8367C_RX_LENGTH_CTRL_OFFSET, pRxLengthMode)) != RT_ERR_OK)
        return retVal;
