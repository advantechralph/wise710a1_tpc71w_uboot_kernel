 ...
 */
rtk_api_ret_t rtk_l2_init(struct phy_device *phydev)
{
    ...
    if ((retVal = rtl8367c_setAsicLutIpMulticastLookup(phydev, DISABLED)) != RT_ERR_OK)
        return retVal;

    /*Enable CAM Usage*/
    if ((retVal = rtl8367c_setAsicLutCamTbUsage(phydev, ENABLED)) != RT_ERR_OK)
        return retVal;

    if ((retVal = rtl8367c_setAsicLutAgeTimerSpeed(phydev, 6, 2)) != RT_ERR_OK)
        return retVal;

    RTK_SCAN_ALL_LOG_PORT(phydev, port)
    {
        if ((retVal = rtl8367c_setAsicLutLearnLimitNo(phydev, rtk_switch_port_L2P_get(phydev, port), rtk_switch_maxLutAddrNumber_get(phydev))) != RT_ERR_OK)
            return retVal;
    }
 ...
 */
rtk_api_ret_t rtk_l2_addr_add(struct phy_device *phydev, rtk_mac_t *pMac, rtk_l2_ucastAddr_t *pL2_data)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    ...
    RTK_CHK_PORT_VALID(phydev, pL2_data->port);
    ...
    retVal = rtl8367c_getAsicL2LookupTb(phydev, method, &l2Table);
    if (RT_ERR_OK == retVal )
    {
        memcpy(l2Table.mac.octet, pMac->octet, ETHER_ADDR_LEN);
        l2Table.ivl_svl     = pL2_data->ivl;
        ...
        l2Table.fid         = pL2_data->fid;
        l2Table.efid        = pL2_data->efid;
        l2Table.spa         = rtk_switch_port_L2P_get(phydev, pL2_data->port);
        ...
        if((retVal = rtl8367c_setAsicL2LookupTb(phydev, &l2Table)) != RT_ERR_OK)
            return retVal;
 ...
 */
rtk_api_ret_t rtk_l2_addr_get(struct phy_device *phydev, rtk_mac_t *pMac, rtk_l2_ucastAddr_t *pL2_data)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
    ...
    if ((retVal = rtl8367c_getAsicL2LookupTb(phydev, method, &l2Table)) != RT_ERR_OK)
        return retVal;

    memcpy(pL2_data->mac.octet, pMac->octet,ETHER_ADDR_LEN);
    pL2_data->port      = rtk_switch_port_P2L_get(phydev, l2Table.spa);
 ...
 */
rtk_api_ret_t rtk_l2_addr_next_get(struct phy_device *phydev, rtk_l2_read_method_t read_method, rtk_port_t port, rtk_uint32 *pAddress, rtk_l2_ucastAddr_t *pL2_data)
{
    rtk_api_ret_t   retVal;
    rtk_uint32      method;
    rtl8367c_luttb  l2Table;
    ...
    if(read_method == READMETHOD_NEXT_L2UCSPA)
        l2Table.spa = rtk_switch_port_L2P_get(phydev, port);
 ...
 */
rtk_api_ret_t rtk_l2_addr_del(struct phy_device *phydev, rtk_mac_t *pMac, rtk_l2_ucastAddr_t *pL2_data)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
 ...
 */
rtk_api_ret_t rtk_l2_mcastAddr_add(struct phy_device *phydev, rtk_l2_mcastAddr_t *pMcastAddr)
{
    rtk_api_ret_t   retVal;
    rtk_uint32      method;
    rtl8367c_luttb  l2Table;
    ...
    RTK_CHK_PORTMASK_VALID(phydev, &pMcastAddr->portmask);
    ...
    if ((retVal = rtk_switch_portmask_L2P_get(phydev, &pMcastAddr->portmask, &pmask)) != RT_ERR_OK)
        return retVal;
 ...
 *      the mac is learned. Otherwise, it will return a RT_ERR_L2_ENTRY_NOTFOUND error.
 */
rtk_api_ret_t rtk_l2_mcastAddr_get(struct phy_device *phydev, rtk_l2_mcastAddr_t *pMcastAddr)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
    ...
    if ((retVal = rtk_switch_portmask_P2L_get(phydev, l2Table.mbr, &pMcastAddr->portmask)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_l2_mcastAddr_next_get(struct phy_device *phydev, rtk_uint32 *pAddress, rtk_l2_mcastAddr_t *pMcastAddr)
{
    rtk_api_ret_t   retVal;
    rtl8367c_luttb  l2Table;
    ...
    if ((retVal = rtl8367c_getAsicL2LookupTb(phydev, LUTREADMETHOD_NEXT_L2MC, &l2Table)) != RT_ERR_OK)
        return retVal;
 ...
 *      If the mac has existed in the LUT, it will be deleted. Otherwise, it will return RT_ERR_L2_ENTRY_NOTFOUND.
 */
rtk_api_ret_t rtk_l2_mcastAddr_del(struct phy_device *phydev, rtk_l2_mcastAddr_t *pMcastAddr)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
 ...
 */
rtk_api_ret_t rtk_l2_ipMcastAddr_add(struct phy_device *phydev, rtk_l2_ipMcastAddr_t *pIpMcastAddr)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
    ...
    /* check port mask */
    RTK_CHK_PORTMASK_VALID(phydev, &pIpMcastAddr->portmask);
    ...
    /* Get Physical port mask */
    if ((retVal = rtk_switch_portmask_L2P_get(phydev, &pIpMcastAddr->portmask, &pmask)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_l2_ipMcastAddr_get(struct phy_device *phydev, rtk_l2_ipMcastAddr_t *pIpMcastAddr)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
    ...
    /* Get Logical port mask */
    if ((retVal = rtk_switch_portmask_P2L_get(phydev, l2Table.mbr, &pIpMcastAddr->portmask)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_l2_ipMcastAddr_next_get(struct phy_device *phydev, rtk_uint32 *pAddress, rtk_l2_ipMcastAddr_t *pIpMcastAddr)
{
    rtk_api_ret_t   retVal;
    rtl8367c_luttb  l2Table;
    ...
    do
    {
        if ((retVal = rtl8367c_getAsicL2LookupTb(phydev, LUTREADMETHOD_NEXT_L3MC, &l2Table)) != RT_ERR_OK)
            return retVal;
 ...
 */
rtk_api_ret_t rtk_l2_ipMcastAddr_del(struct phy_device *phydev, rtk_l2_ipMcastAddr_t *pIpMcastAddr)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
 ...
 *
 */
rtk_api_ret_t rtk_l2_ipVidMcastAddr_add(struct phy_device *phydev, rtk_l2_ipVidMcastAddr_t *pIpVidMcastAddr)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
    ...
    /* check port mask */
    RTK_CHK_PORTMASK_VALID(phydev, &pIpVidMcastAddr->portmask);
    ...
    /* Get Physical port mask */
    if ((retVal = rtk_switch_portmask_L2P_get(phydev, &pIpVidMcastAddr->portmask, &pmask)) != RT_ERR_OK)
        return retVal;
 ...
 *
 */
rtk_api_ret_t rtk_l2_ipVidMcastAddr_get(struct phy_device *phydev, rtk_l2_ipVidMcastAddr_t *pIpVidMcastAddr)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
    ...
    pIpVidMcastAddr->address = l2Table.address;
     ...
     /* Get Logical port mask */
    if ((retVal = rtk_switch_portmask_P2L_get(phydev, l2Table.mbr, &pIpVidMcastAddr->portmask)) != RT_ERR_OK)
        return retVal;
 ...
 *      as pAddress to call this API again for dumping all IP multicast entries is LUT.
 */
rtk_api_ret_t rtk_l2_ipVidMcastAddr_next_get(struct phy_device *phydev, rtk_uint32 *pAddress, rtk_l2_ipVidMcastAddr_t *pIpVidMcastAddr)
{
    rtk_api_ret_t   retVal;
    rtl8367c_luttb  l2Table;
 ...
 *
 */
rtk_api_ret_t rtk_l2_ipVidMcastAddr_del(struct phy_device *phydev, rtk_l2_ipVidMcastAddr_t *pIpVidMcastAddr)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
 ...
 */
rtk_api_ret_t rtk_l2_ucastAddr_flush(struct phy_device *phydev, rtk_l2_flushCfg_t *pConfig)
{
    rtk_api_ret_t   retVal;
    ...
    /* check port valid */
    RTK_CHK_PORT_VALID(phydev, pConfig->port);

    if(pConfig->flushByVid == ENABLED)
    {
        if ((retVal = rtl8367c_setAsicLutFlushMode(phydev, FLUSHMDOE_VID)) != RT_ERR_OK)
            return retVal;

        if ((retVal = rtl8367c_setAsicLutFlushVid(phydev, pConfig->vid)) != RT_ERR_OK)
                return retVal;

        if ((retVal = rtl8367c_setAsicLutFlushType(phydev, (pConfig->flushStaticAddr == ENABLED) ? FLUSHTYPE_BOTH : FLUSHTYPE_DYNAMIC)) != RT_ERR_OK)
            return retVal;

        if(pConfig->flushAddrOnAllPorts == ENABLED)
        {
            if ((retVal = rtl8367c_setAsicLutForceFlush(phydev, RTL8367C_PORTMASK)) != RT_ERR_OK)
                return retVal;
        }
        else if(pConfig->flushByPort == ENABLED)
        {
            if ((retVal = rtl8367c_setAsicLutForceFlush(phydev, 1 << rtk_switch_port_L2P_get(phydev, pConfig->port))) != RT_ERR_OK)
                return retVal;
        }
        else
            return RT_ERR_INPUT;
    ...
    {
        if ((retVal = rtl8367c_setAsicLutFlushMode(phydev, FLUSHMDOE_FID)) != RT_ERR_OK)
            return retVal;

        if ((retVal = rtl8367c_setAsicLutFlushFid(phydev, pConfig->fid)) != RT_ERR_OK)
                return retVal;
    ...
    else if(pConfig->flushByPort == ENABLED)
    {
        ...
        if ((retVal = rtl8367c_setAsicLutFlushMode(phydev, FLUSHMDOE_PORT)) != RT_ERR_OK)
            return retVal;
 ...
 *
 */
rtk_api_ret_t rtk_l2_table_clear(struct phy_device *phydev)
{
    rtk_api_ret_t   retVal;
    ...
    if ((retVal = rtl8367c_setAsicLutFlushAll(phydev)) != RT_ERR_OK)
        return retVal;
 ...
 *
 */
rtk_api_ret_t rtk_l2_table_clearStatus_get(struct phy_device *phydev, rtk_l2_clearStatus_t *pStatus)
{
    rtk_api_ret_t   retVal;
    ...
    if ((retVal = rtl8367c_getAsicLutFlushAllStatus(phydev, (rtk_uint32 *)pStatus)) != RT_ERR_OK)
        return retVal;
 ...
 *      - ENABLED
 */
rtk_api_ret_t rtk_l2_flushLinkDownPortAddrEnable_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicLutLinkDownForceAging(phydev, enable)) != RT_ERR_OK)
        return retVal;
 ...
 *      - ENABLED
 */
rtk_api_ret_t rtk_l2_flushLinkDownPortAddrEnable_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicLutLinkDownForceAging(phydev, pEnable)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_l2_agingEnable_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicLutDisableAging(phydev, rtk_switch_port_L2P_get(phydev, port), enable)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_l2_agingEnable_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicLutDisableAging(phydev, rtk_switch_port_L2P_get(phydev, port), pEnable)) != RT_ERR_OK)
        return retVal;
 ...
 *      to 2112.
 */
rtk_api_ret_t rtk_l2_limitLearningCnt_set(struct phy_device *phydev, rtk_port_t port, rtk_mac_cnt_t mac_cnt)
{
    rtk_api_ret_t retVal;
    ...
    if (mac_cnt > rtk_switch_maxLutAddrNumber_get(phydev))
        return RT_ERR_LIMITED_L2ENTRY_NUM;

    if ((retVal = rtl8367c_setAsicLutLearnLimitNo(phydev, rtk_switch_port_L2P_get(phydev, port), mac_cnt)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_l2_limitLearningCnt_get(struct phy_device *phydev, rtk_port_t port, rtk_mac_cnt_t *pMac_cnt)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicLutLearnLimitNo(phydev, rtk_switch_port_L2P_get(phydev, port), pMac_cnt)) != RT_ERR_OK)
        return retVal;
 ...
 *      to 2112.
 */
rtk_api_ret_t rtk_l2_limitSystemLearningCnt_set(struct phy_device *phydev, rtk_mac_cnt_t mac_cnt)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicSystemLutLearnLimitNo(phydev, mac_cnt)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_l2_limitSystemLearningCnt_get(struct phy_device *phydev, rtk_mac_cnt_t *pMac_cnt)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicSystemLutLearnLimitNo(phydev, pMac_cnt)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_l2_limitLearningCntAction_set(struct phy_device *phydev, rtk_port_t port, rtk_l2_limitLearnCntAction_t action)
{
    rtk_api_ret_t retVal;
    rtk_uint32 data;
    ...
    if ((retVal = rtl8367c_setAsicLutLearnOverAct(phydev, data)) != RT_ERR_OK)
        return retVal;
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
rtk_api_ret_t rtk_l2_limitLearningCntAction_get(struct phy_device *phydev, rtk_port_t port, rtk_l2_limitLearnCntAction_t *pAction)
{
    rtk_api_ret_t retVal;
    rtk_uint32 action;
    ...
    if ((retVal = rtl8367c_getAsicLutLearnOverAct(phydev, &action)) != RT_ERR_OK)
        return retVal;
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
rtk_api_ret_t rtk_l2_limitSystemLearningCntAction_set(struct phy_device *phydev, rtk_l2_limitLearnCntAction_t action)
{
    rtk_api_ret_t retVal;
    rtk_uint32 data;
    ...
    if ((retVal = rtl8367c_setAsicSystemLutLearnOverAct(phydev, data)) != RT_ERR_OK)
        return retVal;
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
rtk_api_ret_t rtk_l2_limitSystemLearningCntAction_get(struct phy_device *phydev, rtk_l2_limitLearnCntAction_t *pAction)
{
    rtk_api_ret_t retVal;
    rtk_uint32 action;
    ...
    if ((retVal = rtl8367c_getAsicSystemLutLearnOverAct(phydev, &action)) != RT_ERR_OK)
        return retVal;
 ...
 *
 */
rtk_api_ret_t rtk_l2_limitSystemLearningCntPortMask_set(struct phy_device *phydev, rtk_portmask_t *pPortmask)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pmask;
    ...
    if ((retVal = rtl8367c_setAsicSystemLutLearnPortMask(phydev, pmask)) != RT_ERR_OK)
        return retVal;
 ...
 *
 */
rtk_api_ret_t rtk_l2_limitSystemLearningCntPortMask_get(struct phy_device *phydev, rtk_portmask_t *pPortmask)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pmask;
    ...
    if ((retVal = rtl8367c_getAsicSystemLutLearnPortMask(phydev, &pmask)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_l2_learningCnt_get(struct phy_device *phydev, rtk_port_t port, rtk_mac_cnt_t *pMac_cnt)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicLutLearnNo(phydev, rtk_switch_port_L2P_get(phydev, port), pMac_cnt)) != RT_ERR_OK)
        return retVal;
 ...
 *      - FLOOD_BC
 */
rtk_api_ret_t rtk_l2_floodPortMask_set(struct phy_device *phydev, rtk_l2_flood_type_t floood_type, rtk_portmask_t *pFlood_portmask)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pmask;
    ...
    /* check port valid */
    RTK_CHK_PORTMASK_VALID(phydev, pFlood_portmask);

    /* Get Physical port mask */
    if ((retVal = rtk_switch_portmask_L2P_get(phydev, pFlood_portmask, &pmask))!=RT_ERR_OK)
        return retVal;

    switch (floood_type)
    {
        case FLOOD_UNKNOWNDA:
            if ((retVal = rtl8367c_setAsicPortUnknownDaFloodingPortmask(phydev, pmask)) != RT_ERR_OK)
                return retVal;
            break;
        case FLOOD_UNKNOWNMC:
            if ((retVal = rtl8367c_setAsicPortUnknownMulticastFloodingPortmask(phydev, pmask)) != RT_ERR_OK)
                return retVal;
            break;
        case FLOOD_BC:
            if ((retVal = rtl8367c_setAsicPortBcastFloodingPortmask(phydev, pmask)) != RT_ERR_OK)
                return retVal;
            break;
        default:
            break;
 ...
 *      - FLOOD_BC
 */
rtk_api_ret_t rtk_l2_floodPortMask_get(struct phy_device *phydev, rtk_l2_flood_type_t floood_type, rtk_portmask_t *pFlood_portmask)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pmask;
    ...
    {
        case FLOOD_UNKNOWNDA:
            if ((retVal = rtl8367c_getAsicPortUnknownDaFloodingPortmask(phydev, &pmask)) != RT_ERR_OK)
                return retVal;
            break;
        case FLOOD_UNKNOWNMC:
            if ((retVal = rtl8367c_getAsicPortUnknownMulticastFloodingPortmask(phydev, &pmask)) != RT_ERR_OK)
                return retVal;
            break;
        case FLOOD_BC:
            if ((retVal = rtl8367c_getAsicPortBcastFloodingPortmask(phydev, &pmask)) != RT_ERR_OK)
                return retVal;
            break;
        default:
            break;
    ...
    /* Get Logical port mask */
    if ((retVal = rtk_switch_portmask_P2L_get(phydev, pmask, pFlood_portmask))!=RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_l2_localPktPermit_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t permit)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicPortBlockSpa(phydev, rtk_switch_port_L2P_get(phydev, port), permit)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_l2_localPktPermit_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pPermit)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicPortBlockSpa(phydev, rtk_switch_port_L2P_get(phydev, port), pPermit)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_l2_aging_set(struct phy_device *phydev, rtk_l2_age_time_t aging_time)
{
    rtk_uint32 i;
    ...
    for (i = 0; i<10; i++)
    {
        ...
        {
            return rtl8367c_setAsicLutAgeTimerSpeed(phydev, agePara[i][2], agePara[i][1]);
        }
    }
 ...
 */
rtk_api_ret_t rtk_l2_aging_get(struct phy_device *phydev, rtk_l2_age_time_t *pAging_time)
{
    rtk_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicLutAgeTimerSpeed(phydev, &time, &speed)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_l2_ipMcastAddrLookup_set(struct phy_device *phydev, rtk_l2_ipmc_lookup_type_t type)
{
    rtk_api_ret_t retVal;
    ...
    else if(type == LOOKUP_IP)
    {
        ...
        if ((retVal = rtl8367c_setAsicLutIpMulticastVidLookup(phydev, DISABLED))!=RT_ERR_OK)
            return retVal;
    ...
    else if(type == LOOKUP_IP_VID)
    {
        ...
        if ((retVal = rtl8367c_setAsicLutIpMulticastVidLookup(phydev, ENABLED))!=RT_ERR_OK)
            return retVal;
 ...
 *      None.
 */
rtk_api_ret_t rtk_l2_ipMcastAddrLookup_get(struct phy_device *phydev, rtk_l2_ipmc_lookup_type_t *pType)
{
    rtk_api_ret_t       retVal;
    ...
    if((retVal = rtl8367c_getAsicLutIpMulticastLookup(phydev, &enabled)) != RT_ERR_OK)
        return retVal;

    if ((retVal = rtl8367c_getAsicLutIpMulticastVidLookup(phydev, &vid_lookup))!=RT_ERR_OK)
        return retVal;
 ...
 *
 */
rtk_api_ret_t rtk_l2_ipMcastForwardRouterPort_set(struct phy_device *phydev, rtk_enable_t enabled)
{
    rtk_api_ret_t       retVal;
    ...
    if((retVal = rtl8367c_setAsicLutIpmcFwdRouterPort(phydev, enabled)) != RT_ERR_OK)
        return retVal;
 ...
 *
 */
rtk_api_ret_t rtk_l2_ipMcastForwardRouterPort_get(struct phy_device *phydev, rtk_enable_t *pEnabled)
{
    rtk_api_ret_t       retVal;
    ...
    if((retVal = rtl8367c_getAsicLutIpmcFwdRouterPort(phydev, pEnabled)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtk_api_ret_t rtk_l2_ipMcastGroupEntry_add(struct phy_device *phydev, ipaddr_t ip_addr, rtk_uint32 vid, rtk_portmask_t *pPortmask)
{
    ...
    /* Get Physical port mask */
    if ((retVal = rtk_switch_portmask_L2P_get(phydev, pPortmask, &physicalPortmask))!=RT_ERR_OK)
        return retVal;

    for(index = 0; index <= RTL8367C_LUT_IPMCGRP_TABLE_MAX; index++)
    {
        if ((retVal = rtl8367c_getAsicLutIPMCGroup(phydev, (rtk_uint32)index, &group_addr, &group_vid, &pmask, &valid))!=RT_ERR_OK)
            return retVal;
        ...
        if( (valid == ENABLED) && (group_addr == ip_addr) && (group_vid == vid) )
        {
            if(pmask != physicalPortmask)
            {
                ...
                if ((retVal = rtl8367c_setAsicLutIPMCGroup(phydev, index, ip_addr, vid, pmask, valid))!=RT_ERR_OK)
                    return retVal;
            }
    ...
    pmask = physicalPortmask;
    if ((retVal = rtl8367c_setAsicLutIPMCGroup(phydev, empty_idx, ip_addr, vid, pmask, ENABLED))!=RT_ERR_OK)
        return retVal;
 ...
 *      Delete an entry from IP Multicast group table.
 */
rtk_api_ret_t rtk_l2_ipMcastGroupEntry_del(struct phy_device *phydev, ipaddr_t ip_addr, rtk_uint32 vid)
{
    rtk_int32       index;
    ipaddr_t        group_addr;
    rtk_uint32      group_vid;
    ...
    for(index = 0; index <= RTL8367C_LUT_IPMCGRP_TABLE_MAX; index++)
    {
        ...
        if( (valid == ENABLED) && (group_addr == ip_addr) && (group_vid == vid) )
        {
            ...
            group_vid = 0;
            pmask = 0;
            if ((retVal = rtl8367c_setAsicLutIPMCGroup(phydev, index, group_addr, group_vid, pmask, DISABLED))!=RT_ERR_OK)
                return retVal;
 ...
 *      Delete an entry from IP Multicast group table.
 */
rtk_api_ret_t rtk_l2_ipMcastGroupEntry_get(struct phy_device *phydev, ipaddr_t ip_addr, rtk_uint32 vid, rtk_portmask_t *pPortmask)
{
    rtk_int32       index;
    ipaddr_t        group_addr;
    rtk_uint32      group_vid;
 ...
 */
rtk_api_ret_t rtk_l2_entry_get(struct phy_device *phydev, rtk_l2_addr_table_t *pL2_entry)
{
    rtk_api_ret_t retVal;
    rtk_uint32 method;
    rtl8367c_luttb l2Table;
    ...
    if (pL2_entry->index >= rtk_switch_maxLutAddrNumber_get(phydev))
        return RT_ERR_INPUT;
    ...
    if(l2Table.l3lookup)
    {
        if(l2Table.l3vidlookup)
        {
            ...
            /* Get Logical port mask */
            if ((retVal = rtk_switch_portmask_P2L_get(phydev, l2Table.mbr, &(pL2_entry->portmask)))!=RT_ERR_OK)
                return retVal;
    ...
    else if((l2Table.age != 0)||(l2Table.nosalearn == 1))
    {
        ...
        /* Get Logical port mask */
        if ((retVal = rtk_switch_portmask_P2L_get(phydev, 1<<(l2Table.spa), &(pL2_entry->portmask)))!=RT_ERR_OK)
            return retVal;
