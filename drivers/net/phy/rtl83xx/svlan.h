 ...
 */
extern rtk_api_ret_t rtk_svlan_init(struct phy_device *phydev);
 ...
 */
extern rtk_api_ret_t rtk_svlan_servicePort_add(struct phy_device *phydev, rtk_port_t port);
 ...
 *      contain accept SVID in S-tag field.
 */
extern rtk_api_ret_t rtk_svlan_servicePort_get(struct phy_device *phydev, rtk_portmask_t *pSvlan_portmask);
 ...
 */
extern rtk_api_ret_t rtk_svlan_servicePort_del(struct phy_device *phydev, rtk_port_t port);
 ...
 *      User can set mathced ether type as service provider supported protocol.
 */
extern rtk_api_ret_t rtk_svlan_tpidEntry_set(struct phy_device *phydev, rtk_uint32 svlan_tag_id);
 ...
 *      contain accept SVID in S-tag field.
 */
extern rtk_api_ret_t rtk_svlan_tpidEntry_get(struct phy_device *phydev, rtk_uint32 *pSvlan_tag_id);
 ...
 *      - REF_PB_PRI.
 */
extern rtk_api_ret_t rtk_svlan_priorityRef_set(struct phy_device *phydev, rtk_svlan_pri_ref_t ref);
 ...
 *      - REF_PB_PRI
 */
extern rtk_api_ret_t rtk_svlan_priorityRef_get(struct phy_device *phydev, rtk_svlan_pri_ref_t *pRef);
 ...
 */
extern rtk_api_ret_t rtk_svlan_memberPortEntry_set(struct phy_device *phydev, rtk_uint32 svid_idx, rtk_svlan_memberCfg_t *psvlan_cfg);
 ...
 */
extern rtk_api_ret_t rtk_svlan_memberPortEntry_get(struct phy_device *phydev, rtk_uint32 svid_idx, rtk_svlan_memberCfg_t *pSvlan_cfg);
 ...
 *      - rtk_svlan_memberCfg_t->priority is priority of SVLAN member configuration.
 */
extern rtk_api_ret_t rtk_svlan_memberPortEntry_adv_set(struct phy_device *phydev, rtk_uint32 idx, rtk_svlan_memberCfg_t *pSvlan_cfg);
 ...
 *      to receiving from uplink ports. Other SVID S-tag frame or S-untagged frame will be droped.
 */
extern rtk_api_ret_t rtk_svlan_memberPortEntry_adv_get(struct phy_device *phydev, rtk_uint32 idx, rtk_svlan_memberCfg_t *pSvlan_cfg);
 ...
 */
extern rtk_api_ret_t rtk_svlan_defaultSvlan_set(struct phy_device *phydev, rtk_port_t port, rtk_vlan_t svid);
 ...
 *      is transmit through uplink port with s-tag field
 */
extern rtk_api_ret_t rtk_svlan_defaultSvlan_get(struct phy_device *phydev, rtk_port_t port, rtk_vlan_t *pSvid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_c2s_add(struct phy_device *phydev, rtk_vlan_t vid, rtk_port_t src_port, rtk_vlan_t svid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_c2s_del(struct phy_device *phydev, rtk_vlan_t vid, rtk_port_t src_port);
 ...
 */
extern rtk_api_ret_t rtk_svlan_c2s_get(struct phy_device *phydev, rtk_vlan_t vid, rtk_port_t src_port, rtk_vlan_t *pSvid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_untag_action_set(struct phy_device *phydev, rtk_svlan_untag_action_t action, rtk_vlan_t svid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_untag_action_get(struct phy_device *phydev, rtk_svlan_untag_action_t *pAction, rtk_vlan_t *pSvid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_unmatch_action_set(struct phy_device *phydev, rtk_svlan_unmatch_action_t action, rtk_vlan_t svid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_unmatch_action_get(struct phy_device *phydev, rtk_svlan_unmatch_action_t *pAction, rtk_vlan_t *pSvid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_dmac_vidsel_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t enable);
 ...
 */
extern rtk_api_ret_t rtk_svlan_dmac_vidsel_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pEnable);
 ...
 */
extern rtk_api_ret_t rtk_svlan_ipmc2s_add(struct phy_device *phydev, ipaddr_t ipmc, ipaddr_t ipmcMsk, rtk_vlan_t svid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_ipmc2s_del(struct phy_device *phydev, ipaddr_t ipmc, ipaddr_t ipmcMsk);
 ...
 */
extern rtk_api_ret_t rtk_svlan_ipmc2s_get(struct phy_device *phydev, ipaddr_t ipmc, ipaddr_t ipmcMsk, rtk_vlan_t *pSvid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_l2mc2s_add(struct phy_device *phydev, rtk_mac_t mac, rtk_mac_t macMsk, rtk_vlan_t svid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_l2mc2s_del(struct phy_device *phydev, rtk_mac_t mac, rtk_mac_t macMsk);
 ...
 */
extern rtk_api_ret_t rtk_svlan_l2mc2s_get(struct phy_device *phydev, rtk_mac_t mac, rtk_mac_t macMsk, rtk_vlan_t *pSvid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_sp2c_add(struct phy_device *phydev, rtk_vlan_t svid, rtk_port_t dst_port, rtk_vlan_t cvid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_sp2c_get(struct phy_device *phydev, rtk_vlan_t svid, rtk_port_t dst_port, rtk_vlan_t *pCvid);
 ...
 */
extern rtk_api_ret_t rtk_svlan_sp2c_del(struct phy_device *phydev, rtk_vlan_t svid, rtk_port_t dst_port);
 ...
 *      none
 */
extern rtk_api_ret_t rtk_svlan_lookupType_set(struct phy_device *phydev, rtk_svlan_lookupType_t type);
 ...
 *      none
 */
extern rtk_api_ret_t rtk_svlan_lookupType_get(struct phy_device *phydev, rtk_svlan_lookupType_t *pType);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_svlan_trapPri_set(struct phy_device *phydev, rtk_pri_t priority);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_svlan_trapPri_get(struct phy_device *phydev, rtk_pri_t *pPriority);
 ...
 */
extern rtk_api_ret_t rtk_svlan_unassign_action_set(struct phy_device *phydev, rtk_svlan_unassign_action_t action);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_svlan_unassign_action_get(struct phy_device *phydev, rtk_svlan_unassign_action_t *pAction);
 ...
 *
 */
extern rtk_api_ret_t rtk_svlan_checkAndCreateMbr(struct phy_device *phydev, rtk_vlan_t vid, rtk_uint32 *pIndex);
