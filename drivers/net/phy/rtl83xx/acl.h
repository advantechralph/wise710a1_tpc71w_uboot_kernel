 ...
 */
extern rtk_api_ret_t rtk_filter_igrAcl_init(struct phy_device *phydev);
 ...
 */
extern rtk_api_ret_t rtk_filter_igrAcl_field_add(struct phy_device *phydev, rtk_filter_cfg_t *pFilter_cfg, rtk_filter_field_t *pFilter_field);
 ...
 */
extern rtk_api_ret_t rtk_filter_igrAcl_cfg_add(struct phy_device *phydev, rtk_filter_id_t filter_id, rtk_filter_cfg_t *pFilter_cfg, rtk_filter_action_t *pAction, rtk_filter_number_t *ruleNum);
 ...
 */
extern rtk_api_ret_t rtk_filter_igrAcl_cfg_del(struct phy_device *phydev, rtk_filter_id_t filter_id);
 ...
 */
extern rtk_api_ret_t rtk_filter_igrAcl_cfg_delAll(struct phy_device *phydev);
 ...
 *      This function delete all ACL configuration from ASIC.
 */
extern rtk_api_ret_t rtk_filter_igrAcl_cfg_get(struct phy_device *phydev, rtk_filter_id_t filter_id, rtk_filter_cfg_raw_t *pFilter_cfg, rtk_filter_action_t *pAction);
 ...
 */
extern rtk_api_ret_t rtk_filter_igrAcl_unmatchAction_set(struct phy_device *phydev, rtk_port_t port, rtk_filter_unmatch_action_t action);
 ...
 */
extern rtk_api_ret_t rtk_filter_igrAcl_unmatchAction_get(struct phy_device *phydev, rtk_port_t port, rtk_filter_unmatch_action_t* action);
 ...
 *      This function gets action of packets when no ACL configruation matches.
 */
extern rtk_api_ret_t rtk_filter_igrAcl_state_set(struct phy_device *phydev, rtk_port_t port, rtk_filter_state_t state);
 ...
 *      This function gets action of packets when no ACL configruation matches.
 */
extern rtk_api_ret_t rtk_filter_igrAcl_state_get(struct phy_device *phydev, rtk_port_t port, rtk_filter_state_t* state);
 ...
 */
extern rtk_api_ret_t rtk_filter_igrAcl_template_set(struct phy_device *phydev, rtk_filter_template_t *aclTemplate);
 ...
 */
extern rtk_api_ret_t rtk_filter_igrAcl_template_get(struct phy_device *phydev, rtk_filter_template_t *aclTemplate);
 ...
 */
extern rtk_api_ret_t rtk_filter_igrAcl_field_sel_set(struct phy_device *phydev, rtk_uint32 index, rtk_field_sel_t format, rtk_uint32 offset);
 ...
 *      None.
 */
extern rtk_api_ret_t rtk_filter_igrAcl_field_sel_get(struct phy_device *phydev, rtk_uint32 index, rtk_field_sel_t *pFormat, rtk_uint32 *pOffset);
 ...
 */
extern rtk_api_ret_t rtk_filter_iprange_set(struct phy_device *phydev, rtk_uint32 index, rtk_filter_iprange_t type, ipaddr_t upperIp, ipaddr_t lowerIp);
 ...
 *      upperIp must be larger or equal than lowerIp.
 */
extern rtk_api_ret_t rtk_filter_iprange_get(struct phy_device *phydev, rtk_uint32 index, rtk_filter_iprange_t *pType, ipaddr_t *pUpperIp, ipaddr_t *pLowerIp);
 ...
 */
extern rtk_api_ret_t rtk_filter_vidrange_set(struct phy_device *phydev, rtk_uint32 index, rtk_filter_vidrange_t type, rtk_uint32 upperVid, rtk_uint32 lowerVid);
 ...
 *      None.
 */
extern rtk_api_ret_t rtk_filter_vidrange_get(struct phy_device *phydev, rtk_uint32 index, rtk_filter_vidrange_t *pType, rtk_uint32 *pUpperVid, rtk_uint32 *pLowerVid);
 ...
 */
extern rtk_api_ret_t rtk_filter_portrange_set(struct phy_device *phydev, rtk_uint32 index, rtk_filter_portrange_t type, rtk_uint32 upperPort, rtk_uint32 lowerPort);
 ...
 *      None.
 */
extern rtk_api_ret_t rtk_filter_portrange_get(struct phy_device *phydev, rtk_uint32 index, rtk_filter_portrange_t *pType, rtk_uint32 *pUpperPort, rtk_uint32 *pLowerPort);
 ...
 *      none
 */
extern rtk_api_ret_t rtk_filter_igrAclPolarity_set(struct phy_device *phydev, rtk_uint32 polarity);
 ...
 *      none
 */
extern rtk_api_ret_t rtk_filter_igrAclPolarity_get(struct phy_device *phydev, rtk_uint32* pPolarity);
