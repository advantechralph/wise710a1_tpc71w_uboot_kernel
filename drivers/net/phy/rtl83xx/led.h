 ...
 */
extern rtk_api_ret_t rtk_led_enable_set(struct phy_device *phydev, rtk_led_group_t group, rtk_portmask_t *pPortmask);
 ...
 */
extern rtk_api_ret_t rtk_led_enable_get(struct phy_device *phydev, rtk_led_group_t group, rtk_portmask_t *pPortmask);
 ...
 *      - LED_OP_SERIAL,
 */
extern rtk_api_ret_t rtk_led_operation_set(struct phy_device *phydev, rtk_led_operation_t mode);
 ...
 *      - LED_OP_SERIAL,
 */
extern rtk_api_ret_t rtk_led_operation_get(struct phy_device *phydev, rtk_led_operation_t *pMode);
 ...
 *      - LED_FORCE_ON.
 */
extern rtk_api_ret_t rtk_led_modeForce_set(struct phy_device *phydev, rtk_port_t port, rtk_led_group_t group, rtk_led_force_mode_t mode);
 ...
 *      - LED_FORCE_ON.
 */
extern rtk_api_ret_t rtk_led_modeForce_get(struct phy_device *phydev, rtk_port_t port, rtk_led_group_t group, rtk_led_force_mode_t *pMode);
 ...
 */
extern rtk_api_ret_t rtk_led_blinkRate_set(struct phy_device *phydev, rtk_led_blink_rate_t blinkRate);
 ...
 */
extern rtk_api_ret_t rtk_led_blinkRate_get(struct phy_device *phydev, rtk_led_blink_rate_t *pBlinkRate);
 ...
 */
extern rtk_api_ret_t rtk_led_groupConfig_set(struct phy_device *phydev, rtk_led_group_t group, rtk_led_congig_t config);
 ...
 */
extern rtk_api_ret_t rtk_led_groupConfig_get(struct phy_device *phydev, rtk_led_group_t group, rtk_led_congig_t *pConfig);
...
extern rtk_api_ret_t rtk_led_groupAbility_set(struct phy_device *phydev, rtk_led_group_t group, rtk_led_ability_t *pAbility);
...
extern rtk_api_ret_t rtk_led_groupAbility_get(struct phy_device *phydev, rtk_led_group_t group, rtk_led_ability_t *pAbility);
 ...
 */
extern rtk_api_ret_t rtk_led_serialMode_set(struct phy_device *phydev, rtk_led_active_t active);
 ...
 */
extern rtk_api_ret_t rtk_led_serialMode_get(struct phy_device *phydev, rtk_led_active_t *pActive);
 ...
 *      This API set LED I/O state.
 */
extern rtk_api_ret_t rtk_led_OutputEnable_set(struct phy_device *phydev, rtk_enable_t state);
 ...
 */
extern rtk_api_ret_t rtk_led_OutputEnable_get(struct phy_device *phydev, rtk_enable_t *pState);
 ...
 *      None.
 */
extern rtk_api_ret_t rtk_led_serialModePortmask_set(struct phy_device *phydev, rtk_led_serialOutput_t output, rtk_portmask_t *pPortmask);
 ...
 *      None.
 */
extern rtk_api_ret_t rtk_led_serialModePortmask_get(struct phy_device *phydev, rtk_led_serialOutput_t *pOutput, rtk_portmask_t *pPortmask);
