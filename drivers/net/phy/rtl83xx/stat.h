 ...
 */
extern rtk_api_ret_t rtk_stat_global_reset(struct phy_device *phydev);
 ...
 *
 */
extern rtk_api_ret_t rtk_stat_port_reset(struct phy_device *phydev, rtk_port_t port);
 ...
 *
 */
extern rtk_api_ret_t rtk_stat_queueManage_reset(struct phy_device *phydev);
 ...
 */
extern rtk_api_ret_t rtk_stat_global_get(struct phy_device *phydev, rtk_stat_global_type_t cntr_idx, rtk_stat_counter_t *pCntr);
 ...
 */
extern rtk_api_ret_t rtk_stat_global_getAll(struct phy_device *phydev, rtk_stat_global_cntr_t *pGlobal_cntrs);
 ...
 */
extern rtk_api_ret_t rtk_stat_port_get(struct phy_device *phydev, rtk_port_t port, rtk_stat_port_type_t cntr_idx, rtk_stat_counter_t *pCntr);
 ...
 */
extern rtk_api_ret_t rtk_stat_port_getAll(struct phy_device *phydev, rtk_port_t port, rtk_stat_port_cntr_t *pPort_cntrs);
 ...
 *      Set the type and mode of Logging Counter.
 */
extern rtk_api_ret_t rtk_stat_logging_counterCfg_set(struct phy_device *phydev, rtk_uint32 idx, rtk_logging_counter_mode_t mode, rtk_logging_counter_type_t type);
 ...
 *      Get the type and mode of Logging Counter.
 */
extern rtk_api_ret_t rtk_stat_logging_counterCfg_get(struct phy_device *phydev, rtk_uint32 idx, rtk_logging_counter_mode_t *pMode, rtk_logging_counter_type_t *pType);
 ...
 *      Reset Logging Counter.
 */
extern rtk_api_ret_t rtk_stat_logging_counter_reset(struct phy_device *phydev, rtk_uint32 idx);
 ...
 *      Get Logging Counter.
 */
extern rtk_api_ret_t rtk_stat_logging_counter_get(struct phy_device *phydev, rtk_uint32 idx, rtk_uint32 *pCnt);
 ...
 *
 */
extern rtk_api_ret_t rtk_stat_lengthMode_set(struct phy_device *phydev, rtk_stat_lengthMode_t txMode, rtk_stat_lengthMode_t rxMode);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_stat_lengthMode_get(struct phy_device *phydev, rtk_stat_lengthMode_t *pTxMode, rtk_stat_lengthMode_t *pRxMode);
