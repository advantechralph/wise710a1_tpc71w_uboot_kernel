 ...
 */
extern rtk_api_ret_t rtk_ptp_init(struct phy_device *phydev);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_ptp_mac_set(struct phy_device *phydev, rtk_mac_t mac);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_ptp_mac_get(struct phy_device *phydev, rtk_mac_t *pMac);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_ptp_tpid_set(struct phy_device *phydev, rtk_ptp_tpid_t outerId, rtk_ptp_tpid_t innerId);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_ptp_tpid_get(struct phy_device *phydev, rtk_ptp_tpid_t *pOuterId, rtk_ptp_tpid_t *pInnerId);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_ptp_refTime_set(struct phy_device *phydev, rtk_ptp_timeStamp_t timeStamp);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_ptp_refTime_get(struct phy_device *phydev, rtk_ptp_timeStamp_t *pTimeStamp);
 ...
 */
extern rtk_api_ret_t rtk_ptp_refTimeAdjust_set(struct phy_device *phydev, rtk_ptp_sys_adjust_t sign, rtk_ptp_timeStamp_t timeStamp);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_ptp_refTimeEnable_set(struct phy_device *phydev, rtk_enable_t enable);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_ptp_refTimeEnable_get(struct phy_device *phydev, rtk_enable_t *pEnable);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_ptp_portEnable_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t enable);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_ptp_portEnable_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pEnable);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_ptp_portTimestamp_get(struct phy_device *phydev, rtk_port_t port, rtk_ptp_msgType_t type, rtk_ptp_info_t *pInfo);
 ...
 *          PTP_INT_TYPE_ALL,
 */
extern rtk_api_ret_t rtk_ptp_intControl_set(struct phy_device *phydev, rtk_ptp_intType_t type, rtk_enable_t enable);
 ...
 *          PTP_INT_TYPE_RX_PDELAY_RESP,
 */
extern rtk_api_ret_t rtk_ptp_intControl_get(struct phy_device *phydev, rtk_ptp_intType_t type, rtk_enable_t *pEnable);
 ...
 *
 */
extern rtk_api_ret_t rtk_ptp_intStatus_get(struct phy_device *phydev, rtk_ptp_intStatus_t *pStatusMask);
 ...
 */
extern rtk_api_ret_t rtk_ptp_portIntStatus_set(struct phy_device *phydev, rtk_port_t port, rtk_ptp_intStatus_t statusMask);
 ...
 *
 */
extern rtk_api_ret_t rtk_ptp_portIntStatus_get(struct phy_device *phydev, rtk_port_t port, rtk_ptp_intStatus_t *pStatusMask);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_ptp_portTrap_set(struct phy_device *phydev, rtk_port_t port, rtk_enable_t enable);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_ptp_portTrap_get(struct phy_device *phydev, rtk_port_t port, rtk_enable_t *pEnable);
