 ...
 */
ret_t rtl8367c_setAsicI2C_checkBusIdle(struct phy_device *phydev)
{
    rtk_uint32 regData;
    ret_t retVal;

    if ((retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_M_I2C_CTL_STA_REG, RTL8367C_M_I2C_BUS_IDLE_OFFSET, &regData)) != RT_ERR_OK)
        return retVal;
 ...
 */
ret_t rtl8367c_setAsicI2CStartCmd(struct phy_device *phydev)
{
    rtk_uint32 regData;
    ret_t retVal;

    /* Bits [4-1] = 0b0000, Start Command; Bit [0] = 1, Trigger the Command */
    if ((retVal = rtl8367c_getAsicReg(phydev, RTL8367C_REG_M_I2C_CTL_STA_REG, &regData)) != RT_ERR_OK)
        return retVal;
    regData &= 0xFFE0;
    regData |= 0x0001;

    if ((retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_M_I2C_CTL_STA_REG, regData)) != RT_ERR_OK)
        return retVal;

    /* wait for command finished */
    do{
       if ((retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_M_I2C_CTL_STA_REG, RTL8367C_I2C_CMD_EXEC_OFFSET, &regData)) != RT_ERR_OK)
            return retVal;
    }while( regData != 0x0);
 ...
 */
ret_t rtl8367c_setAsicI2CStopCmd(struct phy_device *phydev)
{
 ...
 */
ret_t rtl8367c_setAsicI2CTxOneCharCmd(struct phy_device *phydev, rtk_uint8 oneChar)
{
    rtk_uint32 regData;
    ret_t retVal;
 ...
 */
ret_t rtl8367c_setAsicI2CcheckRxAck(struct phy_device *phydev)
{
    rtk_uint32 regData;
    ret_t retVal;
    rtk_uint32 count = 0;
    ...
    do{
         count++;
         if ((retVal = rtl8367c_getAsicRegBit(phydev, RTL8367C_REG_M_I2C_CTL_STA_REG, RTL8367C_SLV_ACK_FLAG_OFFSET, &regData)) != RT_ERR_OK)
            return retVal;
 ...
 */
ret_t rtl8367c_setAsicI2CRxOneCharCmd(struct phy_device *phydev, rtk_uint8 *pValue)
{
    rtk_uint32 regData;
    ret_t retVal;
 ...
 */
ret_t rtl8367c_setAsicI2CTxAckCmd(struct phy_device *phydev)
{
    rtk_uint32 regData;
    ret_t retVal;
 ...
 */
ret_t rtl8367c_setAsicI2CTxNoAckCmd(struct phy_device *phydev)
{
    rtk_uint32 regData;
    ret_t retVal;
 ...
 */
ret_t rtl8367c_setAsicI2CSoftRSTseqCmd(struct phy_device *phydev)
{
 ...
 */
ret_t rtl8367c_setAsicI2CGpioPinGroup(struct phy_device *phydev, rtk_uint32 pinGroup_ID)
{
    rtk_uint32 regData;
    ret_t retVal;

    if ((retVal = rtl8367c_getAsicReg(phydev, RTL8367C_REG_M_I2C_SYS_CTL, &regData)) != RT_ERR_OK)
         return retVal;
    if( pinGroup_ID==0 )
    {
        regData &= 0x0FFF;
        ...
        if ((retVal = rtl8367c_setAsicReg(phydev, RTL8367C_REG_M_I2C_SYS_CTL, regData)) != RT_ERR_OK)
             return retVal;
    }
 ...
 *      There are three group gpio pins
 */
ret_t rtl8367c_getAsicI2CGpioPinGroup(struct phy_device *phydev, rtk_uint32 * pPinGroup_ID)
{
