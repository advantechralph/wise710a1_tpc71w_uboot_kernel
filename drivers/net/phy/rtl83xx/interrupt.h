 ...
 */
extern rtk_api_ret_t rtk_int_polarity_set(struct phy_device *phydev, rtk_int_polarity_t type);
 ...
 */
extern rtk_api_ret_t rtk_int_polarity_get(struct phy_device *phydev, rtk_int_polarity_t *pType);
 ...
 *      - INT_TYPE_SLIENT
 */
extern rtk_api_ret_t rtk_int_control_set(struct phy_device *phydev, rtk_int_type_t type, rtk_enable_t enable);
 ...
 *      - INT_TYPE_SLIENT
 */
extern rtk_api_ret_t rtk_int_control_get(struct phy_device *phydev, rtk_int_type_t type, rtk_enable_t* pEnable);
 ...
 */
extern rtk_api_ret_t rtk_int_status_set(struct phy_device *phydev, rtk_int_status_t *pStatusMask);
 ...
 *
 */
extern rtk_api_ret_t rtk_int_status_get(struct phy_device *phydev, rtk_int_status_t* pStatusMask);
 ...
 *      The status will be cleared after execute this API.
 */
extern rtk_api_ret_t rtk_int_advanceInfo_get(struct phy_device *phydev, rtk_int_advType_t adv_type, rtk_int_info_t* info);
