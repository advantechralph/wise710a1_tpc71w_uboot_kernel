...
extern ret_t rtl8367c_setAsicFieldSelector(struct phy_device *phydev, rtk_uint32 index, rtk_uint32 format, rtk_uint32 offset);
extern ret_t rtl8367c_getAsicFieldSelector(struct phy_device *phydev, rtk_uint32 index, rtk_uint32* pFormat, rtk_uint32* pOffset);
