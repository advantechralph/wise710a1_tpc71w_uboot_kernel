 ...
 */
#define RTK_MAX_METER_ID(__phydev__)            (rtk_switch_maxMeterId_get(__phydev__))
#define RTK_METER_NUM(__phydev__)               (RTK_MAX_METER_ID(__phydev__) + 1)
 ...
 */
extern rtk_api_ret_t rtk_rate_shareMeterBucket_set(struct phy_device *phydev, rtk_meter_id_t index, rtk_uint32 bucket_size);
 ...
 */
extern rtk_api_ret_t rtk_rate_shareMeterBucket_get(struct phy_device *phydev, rtk_meter_id_t index, rtk_uint32 *pBucket_size);
 ...
 */
extern rtk_api_ret_t rtk_rate_igrBandwidthCtrlRate_set(struct phy_device *phydev, rtk_port_t port, rtk_rate_t rate,  rtk_enable_t ifg_include, rtk_enable_t fc_enable);
 ...
 *     The ifg_include parameter is used for rate calculation with/without inter-frame-gap and preamble.
 */
extern rtk_api_ret_t rtk_rate_igrBandwidthCtrlRate_get(struct phy_device *phydev, rtk_port_t port, rtk_rate_t *pRate, rtk_enable_t *pIfg_include, rtk_enable_t *pFc_enable);
 ...
 *     The ifg_include parameter is used for rate calculation with/without inter-frame-gap and preamble.
 */
extern rtk_api_ret_t rtk_rate_egrBandwidthCtrlRate_set(struct phy_device *phydev, rtk_port_t port, rtk_rate_t rate,  rtk_enable_t ifg_includ);
 ...
 *     The ifg_include parameter is used for rate calculation with/without inter-frame-gap and preamble.
 */
extern rtk_api_ret_t rtk_rate_egrBandwidthCtrlRate_get(struct phy_device *phydev, rtk_port_t port, rtk_rate_t *pRate, rtk_enable_t *pIfg_include);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_rate_egrQueueBwCtrlEnable_set(struct phy_device *phydev, rtk_port_t port, rtk_qid_t queue, rtk_enable_t enable);
 ...
 *    None.
 */
extern rtk_api_ret_t rtk_rate_egrQueueBwCtrlEnable_get(struct phy_device *phydev, rtk_port_t port, rtk_qid_t queue, rtk_enable_t *pEnable);
 ...
 */
extern rtk_api_ret_t rtk_rate_egrQueueBwCtrlRate_set(struct phy_device *phydev, rtk_port_t port, rtk_qid_t queue, rtk_meter_id_t index);
 ...
 *    The unit of granularity is 8Kbps.
 */
extern rtk_api_ret_t rtk_rate_egrQueueBwCtrlRate_get(struct phy_device *phydev, rtk_port_t port, rtk_qid_t queue, rtk_meter_id_t *pIndex);
